...
class FavoritesApi:
    ...
    @validate_call
    async def get_favorite_group_contents(
        self,
        favorite_group_type: Annotated[FavoriteType, Field(description="The type of group to fetch, must be a valid FavoriteType.")],
        favorite_group_name: Annotated[StrictStr, Field(description="The name of the group to fetch, must be a name of a FavoriteGroup.")],
        owner_id: Annotated[Optional[StrictStr], Field(description="The user whose favorite group to return. Must be a user ID.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = await self._get_favorite_group_contents_serialize(
            favorite_group_type=favorite_group_type,
            favorite_group_name=favorite_group_name,
            owner_id=owner_id,
            _request_auth=_request_auth,
    ...
    @validate_call
    async def get_favorite_group_contents_with_http_info(
        self,
        favorite_group_type: Annotated[FavoriteType, Field(description="The type of group to fetch, must be a valid FavoriteType.")],
        favorite_group_name: Annotated[StrictStr, Field(description="The name of the group to fetch, must be a name of a FavoriteGroup.")],
        owner_id: Annotated[Optional[StrictStr], Field(description="The user whose favorite group to return. Must be a user ID.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[FavoriteGroupContents]:
        """List Favorite Group Contents
    ...
    @validate_call
    async def get_favorite_group_contents_without_preload_content(
        self,
        favorite_group_type: Annotated[FavoriteType, Field(description="The type of group to fetch, must be a valid FavoriteType.")],
        favorite_group_name: Annotated[StrictStr, Field(description="The name of the group to fetch, must be a name of a FavoriteGroup.")],
        owner_id: Annotated[Optional[StrictStr], Field(description="The user whose favorite group to return. Must be a user ID.")] = None,
    ...
    async def _get_favorite_group_contents_serialize(
        self,
        favorite_group_type,
        favorite_group_name,
        owner_id,
        ...
        return await self.api_client.param_serialize(
            method='GET',
            resource_path='/favorites/groups/{favoriteGroupType}/{favoriteGroupName}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def get_favorite_groups(
        ...
        type: Annotated[Optional[FavoriteType], Field(description="Filter to a single favorite group type.")] = None,
        user_id: Annotated[Optional[StrictStr], Field(description="Target user to see information on, admin-only.")] = None,
        owner_id: Annotated[Optional[StrictStr], Field(description="The user whose favorite groups to return. Must be a user ID.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    @validate_call
    async def get_favorite_groups_by_type(
        self,
        favorite_group_type: Annotated[FavoriteType, Field(description="The type of group to fetch, must be a valid FavoriteType.")],
        owner_id: Annotated[Optional[StrictStr], Field(description="The user whose favorite groups to return. Must be a user ID.")] = None,
        _request_timeout: Union[
        ...
        _param = await self._get_favorite_groups_by_type_serialize(
            favorite_group_type=favorite_group_type,
            owner_id=owner_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def get_favorite_groups_by_type_with_http_info(
        self,
        favorite_group_type: Annotated[FavoriteType, Field(description="The type of group to fetch, must be a valid FavoriteType.")],
        owner_id: Annotated[Optional[StrictStr], Field(description="The user whose favorite groups to return. Must be a user ID.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def get_favorite_groups_by_type_without_preload_content(
        self,
        favorite_group_type: Annotated[FavoriteType, Field(description="The type of group to fetch, must be a valid FavoriteType.")],
        owner_id: Annotated[Optional[StrictStr], Field(description="The user whose favorite groups to return. Must be a user ID.")] = None,
        _request_timeout: Union[
    ...
    async def _get_favorite_groups_by_type_serialize(
        self,
        favorite_group_type,
        owner_id,
        _request_auth,
        ...
        return await self.api_client.param_serialize(
            method='GET',
            resource_path='/favorites/groups/{favoriteGroupType}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
