...
class InventoryApi:
    ...
    @validate_call
    async def get_cosmetic_index(
        self,
        item_type: Annotated[StrictStr, Field(description="The kind of cosmetic to list.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = await self._get_cosmetic_index_serialize(
            item_type=item_type,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def get_cosmetic_index_with_http_info(
        self,
        item_type: Annotated[StrictStr, Field(description="The kind of cosmetic to list.")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[InventoryTemplate]]:
        """List Cosmetics
    ...
    @validate_call
    async def get_cosmetic_index_without_preload_content(
        self,
        item_type: Annotated[StrictStr, Field(description="The kind of cosmetic to list.")],
        _request_timeout: Union[
            None,
    ...
    async def _get_cosmetic_index_serialize(
        self,
        item_type,
        _request_auth,
        _content_type,
        ...
        if item_type is not None:
            _path_params['itemType'] = item_type
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return await self.api_client.param_serialize(
            method='GET',
            resource_path='/cosmetics/index/{itemType}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def get_inventory(
        ...
        is_nav_bar: Optional[StrictBool] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    async def _get_inventory_serialize(
        ...
        if is_nav_bar is not None:
            
            _query_params.append(('isNavBar', is_nav_bar))
    ...
    async def get_user_cosmetics(
        ...
        _param = await self._get_user_cosmetics_serialize(
            user_id=user_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def get_user_cosmetics_with_http_info(
        self,
        user_id: Annotated[StrictStr, Field(description="Must be a valid user ID.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_user_cosmetics_without_preload_content(
        self,
        user_id: Annotated[StrictStr, Field(description="Must be a valid user ID.")],
        _request_timeout: Union[
            None,
    ...
    async def _get_user_cosmetics_serialize(
        self,
        user_id,
        _request_auth,
        _content_type,
        ...
        return await self.api_client.param_serialize(
            method='GET',
            resource_path='/user/{userId}/cosmetics',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
