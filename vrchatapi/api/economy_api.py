...
class EconomyApi:
    ...
    async def get_economy_account(
        self,
        user_id: Annotated[StrictStr, Field(description="Must be a valid user ID.")],
        get_limits: Annotated[Optional[StrictBool], Field(description="Include the account's spending limits in the response.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    async def _get_economy_account_serialize(
        ...
        if get_limits is not None:
            ...
            _query_params.append(('getLimits', get_limits))
    ...
    async def get_economy_balance(
        ...
        _param = await self._get_economy_balance_serialize(
            user_id=user_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def get_economy_balance_with_http_info(
        self,
        user_id: Annotated[StrictStr, Field(description="Must be a valid user ID.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_economy_balance_without_preload_content(
        self,
        user_id: Annotated[StrictStr, Field(description="Must be a valid user ID.")],
        _request_timeout: Union[
            None,
    ...
    async def _get_economy_balance_serialize(
        self,
        user_id,
        _request_auth,
        _content_type,
        ...
        return await self.api_client.param_serialize(
            method='GET',
            resource_path='/user/{userId}/economy/balance',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def get_economy_status(
        ...
        _param = await self._get_economy_status_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def get_economy_status_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def get_economy_status_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    async def _get_economy_status_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    @validate_call
    async def get_product_listing_products(
        self,
        product_id: Annotated[StrictStr, Field(description="Must be a valid product ID.")],
        _request_timeout: Union[
            None,
        ...
        _param = await self._get_product_listing_products_serialize(
            product_id=product_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def get_product_listing_products_with_http_info(
        self,
        product_id: Annotated[StrictStr, Field(description="Must be a valid product ID.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_product_listing_products_without_preload_content(
        self,
        product_id: Annotated[StrictStr, Field(description="Must be a valid product ID.")],
        _request_timeout: Union[
            None,
    ...
    async def _get_product_listing_products_serialize(
        self,
        product_id,
        _request_auth,
        _content_type,
        ...
        return await self.api_client.param_serialize(
            method='GET',
            resource_path='/listing/{productId}/products',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def get_product_purchases(
        self,
        active: Annotated[Optional[StrictBool], Field(description="Filter for users' listings and inventory bundles.")] = None,
        buyer_id: Annotated[Optional[StrictStr], Field(description="Must be a valid user ID.")] = None,
        receiver_id: Annotated[Optional[StrictStr], Field(description="Must be a valid user ID.")] = None,
        seller_id: Annotated[Optional[StrictStr], Field(description="Filter results by seller.")] = None,
        n: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="The number of objects to return.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="A zero-based offset from the default object sorting from where search results start.")] = None,
        most_recent: Optional[StrictBool] = None,
    ...
    async def get_store(
        self,
        store_id: StrictStr,
        hydrate_context: Optional[StrictBool] = None,
    ...
    async def _get_store_serialize(
        ...
        if hydrate_context is not None:
            
            _query_params.append(('hydrateContext', hydrate_context))
    ...
    async def get_subscriptions(
        self,
        gifts: Annotated[Optional[StrictBool], Field(description="Return giftable subscriptions instead of standard ones.")] = None,
        recurring: Annotated[Optional[StrictBool], Field(description="Return recurring subscriptions instead of standard ones.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    async def _get_subscriptions_serialize(
        ...
        if gifts is not None:
            ...
            _query_params.append(('gifts', gifts))
    ...
    async def list_stores(
        self,
        seller_id: Annotated[StrictStr, Field(description="Seller to scope the results to.")],
