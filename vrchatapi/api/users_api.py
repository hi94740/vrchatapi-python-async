...
class UsersApi:
    ...
    async def get_age_verification_status(
        ...
        _param = await self._get_age_verification_status_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def get_age_verification_status_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AgeVerificationStatusResult]:
        """Get Age Verification Status
    ...
    @validate_call
    async def get_age_verification_status_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    async def _get_age_verification_status_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return await self.api_client.param_serialize(
            method='GET',
            resource_path='/ageVerification/status',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def get_public_profile(
        self,
        user_id: Annotated[StrictStr, Field(description="Must be a valid user ID.")],
        as_self: Annotated[Optional[StrictBool], Field(description="Include the properties VRChat shows a user on their own profile. Ignored for any other user.")] = None,
        with_groups_and_worlds: Annotated[Optional[StrictBool], Field(description="Include `groups`, `publicWorlds`, `totalPublicWorldsCount` and `worldFavoriteLists` in the response.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = await self._get_public_profile_serialize(
            user_id=user_id,
            as_self=as_self,
            with_groups_and_worlds=with_groups_and_worlds,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    async def _get_public_profile_serialize(
        ...
        if as_self is not None:
            ...
            _query_params.append(('asSelf', as_self))
            
        if with_groups_and_worlds is not None:
            
            _query_params.append(('withGroupsAndWorlds', with_groups_and_worlds))
    ...
    @validate_call
    async def get_user_client_config(
        self,
        user_id: Annotated[StrictStr, Field(description="Must be a valid user ID.")],
        _request_timeout: Union[
            None,
        ...
        _param = await self._get_user_client_config_serialize(
            user_id=user_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def get_user_client_config_with_http_info(
        self,
        user_id: Annotated[StrictStr, Field(description="Must be a valid user ID.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_user_client_config_without_preload_content(
        self,
        user_id: Annotated[StrictStr, Field(description="Must be a valid user ID.")],
        _request_timeout: Union[
            None,
    ...
    async def _get_user_client_config_serialize(
        self,
        user_id,
        _request_auth,
        _content_type,
        ...
        return await self.api_client.param_serialize(
            method='GET',
            resource_path='/users/{userId}/clientConfig',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def update_profile(
        ...
        _param = await self._update_profile_serialize(
            user_id=user_id,
    ...
    async def _update_profile_serialize(
        self,
        user_id,
    ...
    @validate_call
    async def update_user_client_config(
        self,
        user_id: Annotated[StrictStr, Field(description="Must be a valid user ID.")],
        update_user_client_config_request: Optional[UpdateUserClientConfigRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = await self._update_user_client_config_serialize(
            user_id=user_id,
            update_user_client_config_request=update_user_client_config_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def update_user_client_config_with_http_info(
        self,
        user_id: Annotated[StrictStr, Field(description="Must be a valid user ID.")],
        update_user_client_config_request: Optional[UpdateUserClientConfigRequest] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def update_user_client_config_without_preload_content(
        self,
        user_id: Annotated[StrictStr, Field(description="Must be a valid user ID.")],
        update_user_client_config_request: Optional[UpdateUserClientConfigRequest] = None,
        _request_timeout: Union[
    ...
    async def _update_user_client_config_serialize(
        self,
        user_id,
        ...
        # process the form parameters
        # process the body parameter
        if update_user_client_config_request is not None:
            _body_params = update_user_client_config_request
