...
class MiscellaneousApi:
    ...
    async def get_beta(
        self,
        beta_name: Annotated[StrictStr, Field(description="The name of a beta program.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = await self._get_beta_serialize(
            beta_name=beta_name,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def get_beta_with_http_info(
        self,
        beta_name: Annotated[StrictStr, Field(description="The name of a beta program.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_beta_without_preload_content(
        self,
        beta_name: Annotated[StrictStr, Field(description="The name of a beta program.")],
        _request_timeout: Union[
            None,
    ...
    async def _get_beta_serialize(
        ...
        if beta_name is not None:
            _path_params['betaName'] = beta_name
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
    ...
    async def get_beta_registration(
        ...
        _param = await self._get_beta_registration_serialize(
            beta_name=beta_name,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '401': "Error",
            '404': "BetaRegistrationNotFoundError",
        }
        response_data = await self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    async def get_beta_registration_with_http_info(
        self,
        beta_name: Annotated[StrictStr, Field(description="The name of a beta program.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_beta_registration_without_preload_content(
        self,
        beta_name: Annotated[StrictStr, Field(description="The name of a beta program.")],
        _request_timeout: Union[
            None,
    ...
    async def _get_beta_registration_serialize(
        self,
        beta_name,
        _request_auth,
        _content_type,
        ...
        return await self.api_client.param_serialize(
            method='GET',
            resource_path='/beta/{betaName}/register',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def get_frontend_branches(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = await self._get_frontend_branches_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def get_frontend_branches_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def get_frontend_branches_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    async def _get_frontend_branches_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return await self.api_client.param_serialize(
            method='GET',
            resource_path='/frontend/branches',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
