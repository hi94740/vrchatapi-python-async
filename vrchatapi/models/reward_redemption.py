...
class RewardRedemption(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[RewardRedemptionData] = None
    type: Optional[StrictStr] = Field(default=None, description="One of `badge`, `item`, ...")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": RewardRedemptionData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "type": obj.get("type")
        })
        return _obj
