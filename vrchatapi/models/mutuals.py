...
class Mutuals(BaseModel):
    ...
    """ # noqa: E501
    friends: Optional[Annotated[int, Field(strict=True, ge=0)]] = None
    groups: Optional[Annotated[int, Field(strict=True, ge=0)]] = None
    ...
    __properties: ClassVar[List[str]] = ["friends", "groups"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "friends": obj.get("friends") if obj.get("friends") is not None else 0,
            "groups": obj.get("groups") if obj.get("groups") is not None else 0
        })
        return _obj
