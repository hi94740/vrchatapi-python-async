...
class InfoPushDataDomainListInner(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InfoPushDataDomainListInner from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        """Return all declared model fields using public or wire names."""
        return {
            ("domain" if serialize else "domain"): _to_legacy_value(getattr(self, "domain", None), serialize),
        }
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InfoPushDataDomainListInner from a dict"""
        if obj is None:
            return None
