...
class InventoryNotificationDetails(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["body", "imageUrl", "title"]
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("body" if serialize else "body"): _to_legacy_value(getattr(self, "body", None), serialize),
