...
class APIConfigEventShelfCampaign(BaseModel):
    """
    ...
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["Include this event in the VRChat Tanabata event shelf."]})
    key: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["tanabata"]})
    name: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["Tanabata Homeworld Moderation"]})
