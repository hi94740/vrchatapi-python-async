...
class RequestInviteRequest(BaseModel):
    ...
    """ # noqa: E501
    request_slot: Optional[Annotated[int, Field(le=11, strict=True, ge=0)]] = Field(default=None, validation_alias=AliasChoices("requestSlot", "request_slot"), serialization_alias="requestSlot")
    ...
    __properties: ClassVar[List[str]] = ["requestSlot"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "requestSlot" not in obj and "request_slot" in obj:
            obj["requestSlot"] = obj["request_slot"]
        obj.pop("request_slot", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("requestSlot" if serialize else "request_slot"): _to_legacy_value(getattr(self, "request_slot", None), serialize),
        }
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requestSlot": obj.get("requestSlot")
        })
        return _obj
