...
class EconomyPayoutEligibility(BaseModel):
    """
    ...
    ok_balance: Optional[StrictBool] = Field(default=None, validation_alias=AliasChoices("okBalance", "ok_balance"), serialization_alias="okBalance")
    ok_frequency: Optional[StrictBool] = Field(default=None, validation_alias=AliasChoices("okFrequency", "ok_frequency"), serialization_alias="okFrequency")
    ok_not_ongoing: Optional[StrictBool] = Field(default=None, validation_alias=AliasChoices("okNotOngoing", "ok_not_ongoing"), serialization_alias="okNotOngoing")
    ok_standing: Optional[StrictBool] = Field(default=None, validation_alias=AliasChoices("okStanding", "ok_standing"), serialization_alias="okStanding")
    ...
    __properties: ClassVar[List[str]] = ["issue", "okBalance", "okFrequency", "okNotOngoing", "okStanding"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "okBalance" not in obj and "ok_balance" in obj:
            obj["okBalance"] = obj["ok_balance"]
        obj.pop("ok_balance", None)
        if "okFrequency" not in obj and "ok_frequency" in obj:
            obj["okFrequency"] = obj["ok_frequency"]
        obj.pop("ok_frequency", None)
        if "okNotOngoing" not in obj and "ok_not_ongoing" in obj:
            obj["okNotOngoing"] = obj["ok_not_ongoing"]
        obj.pop("ok_not_ongoing", None)
        if "okStanding" not in obj and "ok_standing" in obj:
            obj["okStanding"] = obj["ok_standing"]
        obj.pop("ok_standing", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("issue" if serialize else "issue"): _to_legacy_value(getattr(self, "issue", None), serialize),
            ("okBalance" if serialize else "ok_balance"): _to_legacy_value(getattr(self, "ok_balance", None), serialize),
            ("okFrequency" if serialize else "ok_frequency"): _to_legacy_value(getattr(self, "ok_frequency", None), serialize),
            ("okNotOngoing" if serialize else "ok_not_ongoing"): _to_legacy_value(getattr(self, "ok_not_ongoing", None), serialize),
            ("okStanding" if serialize else "ok_standing"): _to_legacy_value(getattr(self, "ok_standing", None), serialize),
        }
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "issue": obj.get("issue"),
            "okBalance": obj.get("okBalance"),
            "okFrequency": obj.get("okFrequency"),
            "okNotOngoing": obj.get("okNotOngoing"),
            "okStanding": obj.get("okStanding")
        })
        return _obj
