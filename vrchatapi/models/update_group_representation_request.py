...
class UpdateGroupRepresentationRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    is_representing: Optional[StrictBool] = Field(default=None, validation_alias=AliasChoices("isRepresenting", "is_representing"), serialization_alias="isRepresenting", description="Whether the user is representing the group.")
    ...
    __properties: ClassVar[List[str]] = ["isRepresenting"]
