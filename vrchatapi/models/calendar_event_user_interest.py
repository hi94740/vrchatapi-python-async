...
class CalendarEventUserInterest(BaseModel):
    """
    ...
    is_following: Optional[StrictBool] = Field(default=None, validation_alias=AliasChoices("isFollowing", "is_following"), serialization_alias="isFollowing")
    ...
    __properties: ClassVar[List[str]] = ["createdAt", "isFollowing", "updatedAt"]
