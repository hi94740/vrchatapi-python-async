...
class InviteRequest(BaseModel):
    ...
    message_slot: Optional[Annotated[int, Field(le=11, strict=True, ge=0)]] = Field(default=None, validation_alias=AliasChoices("messageSlot", "message_slot"), serialization_alias="messageSlot")
    ...
    __properties: ClassVar[List[str]] = ["instanceId", "messageSlot"]
    ...
    def __preprocess_input_names(
        ...
        if "messageSlot" not in obj and "message_slot" in obj:
            obj["messageSlot"] = obj["message_slot"]
        obj.pop("message_slot", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("messageSlot" if serialize else "message_slot"): _to_legacy_value(getattr(self, "message_slot", None), serialize),
        }
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "messageSlot": obj.get("messageSlot")
        })
        return _obj
