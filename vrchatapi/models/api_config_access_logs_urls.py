...
class APIConfigAccessLogsUrls(BaseModel):
    """
    ...
    """ # noqa: E501
    default: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("Default", "default"), serialization_alias="Default", json_schema_extra={"examples": ["https://help.vrchat.com/hc/en-us/articles/9521522810899-Where-do-I-find-my-output-logs#h_01HT1ZV67JGKX5AE4R1P28XMXR"]})
    pico: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("Pico", "pico"), serialization_alias="Pico", json_schema_extra={"examples": ["https://help.vrchat.com/hc/en-us/articles/9521522810899-Where-do-I-find-my-output-logs#h_01HT1ZV67JGKX5AE4R1P28XMXR"]})
    quest: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("Quest", "quest"), serialization_alias="Quest", json_schema_extra={"examples": ["https://help.vrchat.com/hc/en-us/articles/9521522810899-Where-do-I-find-my-output-logs#h_01HT1ZV67JGKX5AE4R1P28XMXR"]})
    xr_elite: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("XRElite", "xr_elite"), serialization_alias="XRElite", json_schema_extra={"examples": ["https://help.vrchat.com/hc/en-us/articles/9521522810899-Where-do-I-find-my-output-logs#h_01HT1ZV67JGKX5AE4R1P28XMXR"]})
    ...
    __properties: ClassVar[List[str]] = ["Default", "Pico", "Quest", "XRElite"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of APIConfigAccessLogsUrls from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of APIConfigAccessLogsUrls from a dict"""
        if obj is None:
            return None
