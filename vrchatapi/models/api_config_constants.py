...
class APIConfigConstants(BaseModel):
    """
    Constants
    ...
    """ # noqa: E501
    groups: Optional[APIConfigConstantsGROUPS] = Field(default=None, validation_alias=AliasChoices("GROUPS", "groups"), serialization_alias="GROUPS")
    instance: Optional[APIConfigConstantsINSTANCE] = Field(default=None, validation_alias=AliasChoices("INSTANCE", "instance"), serialization_alias="INSTANCE")
    language: Optional[APIConfigConstantsLANGUAGE] = Field(default=None, validation_alias=AliasChoices("LANGUAGE", "language"), serialization_alias="LANGUAGE")
    ...
    __properties: ClassVar[List[str]] = ["GROUPS", "INSTANCE", "LANGUAGE"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "GROUPS" not in obj and "groups" in obj:
            obj["GROUPS"] = obj["groups"]
        obj.pop("groups", None)
        if "INSTANCE" not in obj and "instance" in obj:
            obj["INSTANCE"] = obj["instance"]
        obj.pop("instance", None)
        if "LANGUAGE" not in obj and "language" in obj:
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("LANGUAGE" if serialize else "language"): _to_legacy_value(getattr(self, "language", None), serialize),
        }
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.instance:
            _dict['INSTANCE'] = _to_openapi_value(self.instance)
        # override the default output from pydantic by calling `to_dict()` of language
        if self.language:
            _dict['LANGUAGE'] = _to_openapi_value(self.language)
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "GROUPS": APIConfigConstantsGROUPS.from_dict(obj["GROUPS"]) if obj.get("GROUPS") is not None else None,
            "INSTANCE": APIConfigConstantsINSTANCE.from_dict(obj["INSTANCE"]) if obj.get("INSTANCE") is not None else None,
            "LANGUAGE": APIConfigConstantsLANGUAGE.from_dict(obj["LANGUAGE"]) if obj.get("LANGUAGE") is not None else None
        })
        return _obj
