...
class UpdateAssetReviewNotesRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    review_notes: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("reviewNotes", "review_notes"), serialization_alias="reviewNotes")
    ...
    __properties: ClassVar[List[str]] = ["reviewNotes"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "reviewNotes" not in obj and "review_notes" in obj:
            obj["reviewNotes"] = obj["review_notes"]
        obj.pop("review_notes", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("reviewNotes" if serialize else "review_notes"): _to_legacy_value(getattr(self, "review_notes", None), serialize),
        }
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "reviewNotes": obj.get("reviewNotes")
        })
        return _obj
