...
class FavoriteGroupContents(BaseModel):
    """
    ...
    """ # noqa: E501
    favorites: Optional[List[FavoriteGroupContentsEntry]] = None
    total_count: Optional[StrictInt] = Field(default=None, validation_alias=AliasChoices("totalCount", "total_count"), serialization_alias="totalCount")
    ...
    __properties: ClassVar[List[str]] = ["favorites", "totalCount"]
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.favorites:
            for _item_favorites in self.favorites:
                if _item_favorites:
                    _items.append(_to_openapi_value(_item_favorites))
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "favorites": [FavoriteGroupContentsEntry.from_dict(_item) for _item in obj["favorites"]] if obj.get("favorites") is not None else None,
