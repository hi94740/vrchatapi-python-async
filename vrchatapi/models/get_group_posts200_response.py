...
class GetGroupPosts200Response(BaseModel):
    """
    ...
    """ # noqa: E501
    posts: Optional[List[GroupPost]] = None
    ...
    __properties: ClassVar[List[str]] = ["posts", "total"]
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("posts" if serialize else "posts"): _to_legacy_value(getattr(self, "posts", None), serialize),
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.posts:
            for _item_posts in self.posts:
                if _item_posts:
                    _items.append(_to_openapi_value(_item_posts))
            _dict['posts'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "posts": [GroupPost.from_dict(_item) for _item in obj["posts"]] if obj.get("posts") is not None else None,
            "total": obj.get("total")
        })
        return _obj
