...
class LimitedUserGroups(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["bannerId", "bannerUrl", "description", "discriminator", "groupId", "iconId", "iconUrl", "id", "isRepresenting", "lastPostCreatedAt", "lastPostReadAt", "memberCount", "memberVisibility", "mutualGroup", "name", "ownerId", "privacy", "shortCode"]
