...
class PropUnityPackage(BaseModel):
    """
    ...
    """ # noqa: E501
    asset_url: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("assetUrl", "asset_url"), serialization_alias="assetUrl", json_schema_extra={"examples": ["https://api.vrchat.cloud/api/1/file/file_c991c050-8b43-4046-8182-24d068524ac5/24/file"]})
    ...
    unity_version: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, validation_alias=AliasChoices("unityVersion", "unity_version"), serialization_alias="unityVersion", json_schema_extra={"examples": ["2022.3.22f1"]})
    ...
    __properties: ClassVar[List[str]] = ["assetUrl", "assetVersion", "platform", "propSignature", "unityVersion", "variant"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "unityVersion": obj.get("unityVersion") if obj.get("unityVersion") is not None else '2022.3.22f1',
