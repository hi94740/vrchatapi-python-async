...
class GroupGalleryImageList(BaseModel):
    """
    ...
    """ # noqa: E501
    results: Optional[List[GroupGalleryImage]] = None
    total_count: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, validation_alias=AliasChoices("totalCount", "total_count"), serialization_alias="totalCount")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [GroupGalleryImage.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
