...
class Pending2FAResult(BaseModel):
    """
    Pending2FAResult
    ...
    """ # noqa: E501
    qr_code_data_url: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("qrCodeDataUrl", "qr_code_data_url"), serialization_alias="qrCodeDataUrl")
    ...
    __properties: ClassVar[List[str]] = ["qrCodeDataUrl", "secret"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "qrCodeDataUrl" not in obj and "qr_code_data_url" in obj:
            obj["qrCodeDataUrl"] = obj["qr_code_data_url"]
        obj.pop("qr_code_data_url", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("qrCodeDataUrl" if serialize else "qr_code_data_url"): _to_legacy_value(getattr(self, "qr_code_data_url", None), serialize),
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "qrCodeDataUrl": obj.get("qrCodeDataUrl"),
