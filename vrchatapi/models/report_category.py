...
class ReportCategory(BaseModel):
    ...
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="The description of the report category")
    ips_article: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("ipsArticle", "ips_article"), serialization_alias="ipsArticle")
    order: Optional[StrictInt] = None
    text: Optional[StrictStr] = Field(default=None, description="The label of the report category")
    title: Optional[StrictStr] = Field(default=None, description="The title of the report category")
    tooltip: Optional[StrictStr] = Field(default=None, description="The tooltip that describes the category")
    ...
    __properties: ClassVar[List[str]] = ["description", "ipsArticle", "order", "text", "title", "tooltip"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "ipsArticle" not in obj and "ips_article" in obj:
            obj["ipsArticle"] = obj["ips_article"]
        obj.pop("ips_article", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("ipsArticle" if serialize else "ips_article"): _to_legacy_value(getattr(self, "ips_article", None), serialize),
            ...
            ("tooltip" if serialize else "tooltip"): _to_legacy_value(getattr(self, "tooltip", None), serialize),
        }
