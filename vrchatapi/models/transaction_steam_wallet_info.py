...
class TransactionSteamWalletInfo(BaseModel):
    """
    ...
    """ # noqa: E501
    country: Optional[Annotated[str, Field(min_length=2, strict=True)]] = Field(default=None, json_schema_extra={"examples": ["SE"]})
    currency: Optional[Annotated[str, Field(min_length=3, strict=True)]] = Field(default=None, json_schema_extra={"examples": ["EUR"]})
    state: Optional[StrictStr] = None
    status: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, json_schema_extra={"examples": ["Trusted"]})
    ...
    __properties: ClassVar[List[str]] = ["country", "currency", "state", "status"]
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("country" if serialize else "country"): _to_legacy_value(getattr(self, "country", None), serialize),
