...
class LimitedUserSearch(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["bannerColor", "bannerType", "bannerUrl", "developerType", "displayName", "iconFrame", "iconUrl", "id", "isFriend", "last_platform", "nameplateEffect", "profileEffect", "pronouns", "status", "statusDescription", "tags"]
