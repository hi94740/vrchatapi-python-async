...
class PurchaseContextData(BaseModel):
    """
    PurchaseContextData
    ...
    """ # noqa: E501
    location_type: Optional[ProductPurchaseLocationType] = Field(default=None, validation_alias=AliasChoices("locationType", "location_type"), serialization_alias="locationType")
    ...
    __properties: ClassVar[List[str]] = ["locationType", "storeId", "worldId"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "locationType" not in obj and "location_type" in obj:
            obj["locationType"] = obj["location_type"]
        obj.pop("location_type", None)
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("locationType" if serialize else "location_type"): _to_legacy_value(getattr(self, "location_type", None), serialize),
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "locationType": obj.get("locationType") if obj.get("locationType") is not None else ProductPurchaseLocationType.WEB_GROUP_STORE,
