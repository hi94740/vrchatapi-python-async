...
class BetaRegistrationNotFoundError(BaseModel):
    """
    ...
    """ # noqa: E501
    error: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["No registration found"]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BetaRegistrationNotFoundError from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BetaRegistrationNotFoundError from a dict"""
        if obj is None:
            return None
