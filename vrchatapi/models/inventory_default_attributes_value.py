...
from vrchatapi.models.inventory_default_attributes_value_validator import InventoryDefaultAttributesValueValidator
...
class InventoryDefaultAttributesValue(BaseModel):
    """
    ...
    """ # noqa: E501
    default_value: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("defaultValue", "default_value"), serialization_alias="defaultValue")
    validator: Optional[InventoryDefaultAttributesValueValidator] = None
    ...
    __properties: ClassVar[List[str]] = ["defaultValue", "validator"]
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, InventoryDefaultAttributesValue):
            return False
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("validator" if serialize else "validator"): _to_legacy_value(getattr(self, "validator", None), serialize),
        }
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.validator:
            _dict['validator'] = _to_openapi_value(self.validator)
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "validator": InventoryDefaultAttributesValueValidator.from_dict(obj["validator"]) if obj.get("validator") is not None else None
        })
        return _obj
