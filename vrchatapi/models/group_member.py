...
class GroupMember(BaseModel):
    ...
    is_subscribed_to_announcements: Optional[StrictBool] = Field(default=False, validation_alias=AliasChoices("isSubscribedToAnnouncements", "is_subscribed_to_announcements"), serialization_alias="isSubscribedToAnnouncements")
