...
class ProductListingAttribution(BaseModel):
    """
    ...
    """ # noqa: E501
    collaboration_id: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("collaborationId", "collaboration_id"), serialization_alias="collaborationId")
    creator: Optional[ProductListingAttributionCreator] = None
    publisher: Optional[ProductListingAttributionCreator] = None
    ...
    __properties: ClassVar[List[str]] = ["collaborationId", "creator", "publisher"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "collaborationId" not in obj and "collaboration_id" in obj:
            obj["collaborationId"] = obj["collaboration_id"]
        obj.pop("collaboration_id", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("collaborationId" if serialize else "collaboration_id"): _to_legacy_value(getattr(self, "collaboration_id", None), serialize),
            ("creator" if serialize else "creator"): _to_legacy_value(getattr(self, "creator", None), serialize),
            ("publisher" if serialize else "publisher"): _to_legacy_value(getattr(self, "publisher", None), serialize),
        }
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.creator:
            _dict['creator'] = _to_openapi_value(self.creator)
        # override the default output from pydantic by calling `to_dict()` of publisher
        if self.publisher:
            _dict['publisher'] = _to_openapi_value(self.publisher)
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "collaborationId": obj.get("collaborationId"),
            "creator": ProductListingAttributionCreator.from_dict(obj["creator"]) if obj.get("creator") is not None else None,
            "publisher": ProductListingAttributionCreator.from_dict(obj["publisher"]) if obj.get("publisher") is not None else None
        })
        return _obj
