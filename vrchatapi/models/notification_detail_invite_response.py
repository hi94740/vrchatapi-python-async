...
class NotificationDetailInviteResponse(BaseModel):
    """
    ...
    response_message: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("responseMessage", "response_message"), serialization_alias="responseMessage")
    ...
    __properties: ClassVar[List[str]] = ["inResponseTo", "responseMessage"]
    ...
    def __preprocess_input_names(
        ...
        if "responseMessage" not in obj and "response_message" in obj:
            obj["responseMessage"] = obj["response_message"]
        obj.pop("response_message", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("responseMessage" if serialize else "response_message"): _to_legacy_value(getattr(self, "response_message", None), serialize),
        }
