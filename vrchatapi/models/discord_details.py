...
class DiscordDetails(BaseModel):
    ...
    id: Optional[StrictStr] = Field(default=None, description="https://discord.com/developers/docs/reference#snowflakes", json_schema_extra={"examples": ["1280064052206370848"]})
    ...
    __properties: ClassVar[List[str]] = ["global_name", "id"]
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("global_name" if serialize else "global_name"): _to_legacy_value(getattr(self, "global_name", None), serialize),
