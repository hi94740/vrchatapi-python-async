...
class InstanceVibe(BaseModel):
    ...
    id: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["ivib_2d8445c4-f47b-4635-b565-467fc32c4003"]})
    title: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["adventure"]})
    ...
    __properties: ClassVar[List[str]] = ["deleted", "id", "title"]
