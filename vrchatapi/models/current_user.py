...
class CurrentUser(BaseModel):
    ...
    is_economy_creator: Optional[StrictBool] = Field(default=False, validation_alias=AliasChoices("isEconomyCreator", "is_economy_creator"), serialization_alias="isEconomyCreator")
    ...
    is_temporary: Optional[StrictBool] = Field(default=False, validation_alias=AliasChoices("isTemporary", "is_temporary"), serialization_alias="isTemporary")
    ...
    personalization_opt_out: Optional[StrictBool] = Field(default=None, validation_alias=AliasChoices("personalizationOptOut", "personalization_opt_out"), serialization_alias="personalizationOptOut")
    ...
    temporary_expiry_date: Optional[Any] = Field(default=None, validation_alias=AliasChoices("temporaryExpiryDate", "temporary_expiry_date"), serialization_alias="temporaryExpiryDate")
    ...
    username: Optional[StrictStr] = Field(default=None, description="Your own unique name, used during login. Distinct from `displayName`, and never returned for another user.")
    ...
    def __preprocess_input_names(
        ...
        if "isTemporary" not in obj and "is_temporary" in obj:
            obj["isTemporary"] = obj["is_temporary"]
        obj.pop("is_temporary", None)
        ...
        if "personalizationOptOut" not in obj and "personalization_opt_out" in obj:
            obj["personalizationOptOut"] = obj["personalization_opt_out"]
        obj.pop("personalization_opt_out", None)
        ...
        if "temporaryExpiryDate" not in obj and "temporary_expiry_date" in obj:
            obj["temporaryExpiryDate"] = obj["temporary_expiry_date"]
        obj.pop("temporary_expiry_date", None)
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("isTemporary" if serialize else "is_temporary"): _to_legacy_value(getattr(self, "is_temporary", None), serialize),
            ...
            ("personalizationOptOut" if serialize else "personalization_opt_out"): _to_legacy_value(getattr(self, "personalization_opt_out", None), serialize),
            ...
            ("temporaryExpiryDate" if serialize else "temporary_expiry_date"): _to_legacy_value(getattr(self, "temporary_expiry_date", None), serialize),
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if temporary_expiry_date (nullable) is None
        # and model_fields_set contains the field
        if self.temporary_expiry_date is None and "temporary_expiry_date" in self.model_fields_set:
            _dict['temporaryExpiryDate'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isEconomyCreator": obj.get("isEconomyCreator") if obj.get("isEconomyCreator") is not None else False,
            "isFriend": obj.get("isFriend") if obj.get("isFriend") is not None else False,
            "isTemporary": obj.get("isTemporary") if obj.get("isTemporary") is not None else False,
            ...
            "personalizationOptOut": obj.get("personalizationOptOut"),
            ...
            "tags": obj.get("tags"),
            "temporaryExpiryDate": obj.get("temporaryExpiryDate"),
