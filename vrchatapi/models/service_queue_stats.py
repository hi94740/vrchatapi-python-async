...
class ServiceQueueStats(BaseModel):
    """
    ...
    """ # noqa: E501
    estimated_service_duration_seconds: Optional[StrictInt] = Field(default=None, validation_alias=AliasChoices("estimatedServiceDurationSeconds", "estimated_service_duration_seconds"), serialization_alias="estimatedServiceDurationSeconds")
    ...
    __properties: ClassVar[List[str]] = ["estimatedServiceDurationSeconds"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "estimatedServiceDurationSeconds" not in obj and "estimated_service_duration_seconds" in obj:
            obj["estimatedServiceDurationSeconds"] = obj["estimated_service_duration_seconds"]
        obj.pop("estimated_service_duration_seconds", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("estimatedServiceDurationSeconds" if serialize else "estimated_service_duration_seconds"): _to_legacy_value(getattr(self, "estimated_service_duration_seconds", None), serialize),
        }
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "estimatedServiceDurationSeconds": obj.get("estimatedServiceDurationSeconds")
        })
        return _obj
