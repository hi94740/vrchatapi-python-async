...
class PastDisplayName(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["displayName", "reverted", "updated_at"]
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("reverted" if serialize else "reverted"): _to_legacy_value(getattr(self, "reverted", None), serialize),
