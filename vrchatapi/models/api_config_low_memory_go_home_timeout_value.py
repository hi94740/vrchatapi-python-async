...
class APIConfigLowMemoryGoHomeTimeoutValue(BaseModel):
    """
    ...
    """ # noqa: E501
    timeout: Optional[StrictInt] = Field(default=None, json_schema_extra={"examples": [-1]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of APIConfigLowMemoryGoHomeTimeoutValue from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        """Return all declared model fields using public or wire names."""
        return {
            ("timeout" if serialize else "timeout"): _to_legacy_value(getattr(self, "timeout", None), serialize),
        }
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of APIConfigLowMemoryGoHomeTimeoutValue from a dict"""
        if obj is None:
            return None
