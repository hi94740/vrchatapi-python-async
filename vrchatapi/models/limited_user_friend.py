...
class LimitedUserFriend(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["bio", "bioLinks", "currentAvatarImageUrl", "currentAvatarTags", "currentAvatarThumbnailImageUrl", "developerType", "displayName", "friendKey", "id", "imageUrl", "isFriend", "last_activity", "last_login", "last_mobile", "last_platform", "location", "platform", "profilePicOverride", "profilePicOverrideThumbnail", "status", "statusDescription", "tags", "userIcon"]
