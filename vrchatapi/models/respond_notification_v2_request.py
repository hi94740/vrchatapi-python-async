...
class RespondNotificationV2Request(BaseModel):
    """
    ...
    """ # noqa: E501
    response_data: Optional[StrictStr] = Field(default='', validation_alias=AliasChoices("responseData", "response_data"), serialization_alias="responseData")
    response_type: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("responseType", "response_type"), serialization_alias="responseType", json_schema_extra={"examples": ["Accept:\n  value: accept\nBoop:\n  value: boop\nDecline:\n  value: decline\nDelete:\n  value: delete\nUnsubscribe:\n  value: unsubscribe\n"]})
    ...
    __properties: ClassVar[List[str]] = ["responseData", "responseType"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "responseData" not in obj and "response_data" in obj:
            obj["responseData"] = obj["response_data"]
        obj.pop("response_data", None)
        if "responseType" not in obj and "response_type" in obj:
            obj["responseType"] = obj["response_type"]
        obj.pop("response_type", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("responseData" if serialize else "response_data"): _to_legacy_value(getattr(self, "response_data", None), serialize),
            ("responseType" if serialize else "response_type"): _to_legacy_value(getattr(self, "response_type", None), serialize),
        }
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "responseData": obj.get("responseData") if obj.get("responseData") is not None else '',
