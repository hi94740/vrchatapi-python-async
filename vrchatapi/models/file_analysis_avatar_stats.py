...
class FileAnalysisAvatarStats(BaseModel):
    ...
    raycast_count: Optional[StrictInt] = Field(default=None, validation_alias=AliasChoices("raycastCount", "raycast_count"), serialization_alias="raycastCount")
    ...
    def __preprocess_input_names(
        ...
        if "raycastCount" not in obj and "raycast_count" in obj:
            obj["raycastCount"] = obj["raycast_count"]
        obj.pop("raycast_count", None)
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("raycastCount" if serialize else "raycast_count"): _to_legacy_value(getattr(self, "raycast_count", None), serialize),
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "raycastCount": obj.get("raycastCount"),
