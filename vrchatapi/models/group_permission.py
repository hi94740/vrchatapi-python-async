...
class GroupPermission(BaseModel):
    ...
    depends_on: Optional[List[GroupPermissions]] = Field(default=None, validation_alias=AliasChoices("dependsOn", "depends_on"), serialization_alias="dependsOn", description="Other permission names this one is listed against.")
    ...
    __properties: ClassVar[List[str]] = ["allowedToAdd", "dependsOn", "displayName", "help", "isManagementPermission", "name"]
    ...
    def __preprocess_input_names(
        ...
        if "dependsOn" not in obj and "depends_on" in obj:
            obj["dependsOn"] = obj["depends_on"]
        obj.pop("depends_on", None)
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("dependsOn" if serialize else "depends_on"): _to_legacy_value(getattr(self, "depends_on", None), serialize),
