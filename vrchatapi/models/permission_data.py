...
class PermissionData(BaseModel):
    ...
    """ # noqa: E501
    badges: Optional[List[StrictStr]] = Field(default=None, description="Badges afforded the user by this permission")
    max: Optional[StrictInt] = Field(default=None, description="Maximum value afforded the user by this permission")
    max_favorite_groups: Optional[Dict[str, StrictInt]] = Field(default=None, validation_alias=AliasChoices("maxFavoriteGroups", "max_favorite_groups"), serialization_alias="maxFavoriteGroups", description="Maximum favorite groups afforded the user by this permission")
    max_favorites_per_group: Optional[Dict[str, StrictInt]] = Field(default=None, validation_alias=AliasChoices("maxFavoritesPerGroup", "max_favorites_per_group"), serialization_alias="maxFavoritesPerGroup", description="Maximum favorites per group afforded the user by this permission")
    tags: Optional[List[Annotated[str, Field(min_length=1, strict=True)]]] = Field(default=None, description="Tags afforded the user by this permission")
    ...
    __properties: ClassVar[List[str]] = ["badges", "max", "maxFavoriteGroups", "maxFavoritesPerGroup", "tags"]
