...
class AvatarStyle(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["avst_f0659ed2-094d-48fb-9e40-de05564d96c7"]})
    style_name: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("styleName", "style_name"), serialization_alias="styleName")
    ...
    __properties: ClassVar[List[str]] = ["id", "styleName"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "styleName" not in obj and "style_name" in obj:
            obj["styleName"] = obj["style_name"]
        obj.pop("style_name", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("styleName" if serialize else "style_name"): _to_legacy_value(getattr(self, "style_name", None), serialize),
        }
