...
class FavoriteGroupContentsEntry(BaseModel):
    """
    ...
    favorite_id: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("favoriteId", "favorite_id"), serialization_alias="favoriteId")
    id: Optional[StrictStr] = None
    tags: Optional[List[StrictStr]] = None
    type: Optional[FavoriteType] = None
    world: Optional[FavoriteGroupContentsEntryWorld] = None
    ...
    __properties: ClassVar[List[str]] = ["avatar", "favoriteId", "id", "tags", "type", "world"]
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("avatar" if serialize else "avatar"): _to_legacy_value(getattr(self, "avatar", None), serialize),
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.avatar:
            _dict['avatar'] = _to_openapi_value(self.avatar)
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "world": FavoriteGroupContentsEntryWorld.from_dict(obj["world"]) if obj.get("world") is not None else None
        })
        return _obj
