...
class UpdateUserRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["acceptedTOSVersion", "birthday", "contentFilters", "currentPassword", "displayName", "email", "hasDiscordFriendsOptOut", "hasSharedConnectionsOptOut", "isBoopingEnabled", "password", "pronouns", "revertDisplayName", "status", "statusDescription", "tags", "unsubscribe"]
