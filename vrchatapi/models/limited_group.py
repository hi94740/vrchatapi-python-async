...
class LimitedGroup(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["bannerId", "bannerUrl", "createdAt", "description", "discriminator", "galleries", "iconId", "iconUrl", "id", "isSearchable", "memberCount", "membershipStatus", "name", "nameplateId", "nameplateUrl", "ownerId", "rules", "shortCode", "tags"]
