...
class Permission(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[PermissionData] = None
    ...
    id: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["prms_804ba021-9f47-4e25-9847-1f42fdb2e6ff"]})
    name: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, json_schema_extra={"examples": ["permission-invite-photos"]})
    owner_display_name: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("ownerDisplayName", "owner_display_name"), serialization_alias="ownerDisplayName")
    ...
    __properties: ClassVar[List[str]] = ["data", "description", "displayName", "id", "name", "ownerDisplayName", "ownerId", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": PermissionData.from_dict(obj["data"]) if obj.get("data") is not None else None,
