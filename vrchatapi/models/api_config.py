...
class APIConfig(BaseModel):
    ...
    client_max_datagrams: Optional[StrictInt] = Field(default=None, validation_alias=AliasChoices("clientMaxDatagrams", "client_max_datagrams"), serialization_alias="clientMaxDatagrams")
    ...
    client_use_ack2: Optional[StrictBool] = Field(default=None, validation_alias=AliasChoices("clientUseAck2", "client_use_ack2"), serialization_alias="clientUseAck2")
    ...
    enable_vrc_plus_world_lists: Optional[StrictBool] = Field(default=None, validation_alias=AliasChoices("enableVRCPlusWorldLists", "enable_vrc_plus_world_lists"), serialization_alias="enableVRCPlusWorldLists")
    event_shelf_campaigns: Optional[List[APIConfigEventShelfCampaign]] = Field(default=None, validation_alias=AliasChoices("eventShelfCampaigns", "event_shelf_campaigns"), serialization_alias="eventShelfCampaigns")
    ...
    global_cache_version: Optional[StrictInt] = Field(default=None, validation_alias=AliasChoices("globalCacheVersion", "global_cache_version"), serialization_alias="globalCacheVersion")
    global_cache_version_default: Optional[StrictInt] = Field(default=None, validation_alias=AliasChoices("globalCacheVersionDefault", "global_cache_version_default"), serialization_alias="globalCacheVersionDefault")
    ...
    google_api_unity_client_id: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("googleApiUnityClientId", "google_api_unity_client_id"), serialization_alias="googleApiUnityClientId")
    ...
    loading_screen_weights: Optional[Dict[str, APIConfigLoadingScreenWeights]] = Field(default=None, validation_alias=AliasChoices("loadingScreenWeights", "loading_screen_weights"), serialization_alias="loadingScreenWeights", description="Relative weight of each info-push category on the loading screen, per audience.")
    low_memory_go_home_timeout: Optional[Dict[str, APIConfigLowMemoryGoHomeTimeoutValue]] = Field(default=None, validation_alias=AliasChoices("lowMemoryGoHomeTimeout", "low_memory_go_home_timeout"), serialization_alias="lowMemoryGoHomeTimeout", description="Low-memory timeout, keyed by platform.")
    ...
    maximum_unity_version_for_uploads: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("maximumUnityVersionForUploads", "maximum_unity_version_for_uploads"), serialization_alias="maximumUnityVersionForUploads", json_schema_extra={"examples": ["2023.0.0f0"]})
    ...
    player_url_resolver_sha1_gfn_override: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("player-url-resolver-sha1-gfn-override", "player_url_resolver_sha1_gfn_override"), serialization_alias="player-url-resolver-sha1-gfn-override", description="Overrides `player-url-resolver-sha1` on GeForce Now.")
    ...
    player_url_resolver_version_gfn_override: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("player-url-resolver-version-gfn-override", "player_url_resolver_version_gfn_override"), serialization_alias="player-url-resolver-version-gfn-override", description="Overrides `player-url-resolver-version` on GeForce Now.", json_schema_extra={"examples": ["2026-07-04-GFN"]})
    profile_defaults: Optional[APIConfigProfileDefaults] = Field(default=None, validation_alias=AliasChoices("profileDefaults", "profile_defaults"), serialization_alias="profileDefaults")
    prop_component_list: Optional[List[StrictStr]] = Field(default=None, validation_alias=AliasChoices("propComponentList", "prop_component_list"), serialization_alias="propComponentList", description="SDK3 component type names.")
    ...
    quest_minimum_low_memory_threshold: Optional[Dict[str, StrictInt]] = Field(default=None, validation_alias=AliasChoices("questMinimumLowMemoryThreshold", "quest_minimum_low_memory_threshold"), serialization_alias="questMinimumLowMemoryThreshold", description="Low-memory threshold, keyed by platform.")
    ...
    voice_max_playback_sources_mobile: Optional[StrictInt] = Field(default=None, validation_alias=AliasChoices("voiceMaxPlaybackSourcesMobile", "voice_max_playback_sources_mobile"), serialization_alias="voiceMaxPlaybackSourcesMobile")
    voice_max_playback_sources_pc: Optional[StrictInt] = Field(default=None, validation_alias=AliasChoices("voiceMaxPlaybackSourcesPC", "voice_max_playback_sources_pc"), serialization_alias="voiceMaxPlaybackSourcesPC")
    ...
    def __preprocess_input_names(
        ...
        if "clientMaxDatagrams" not in obj and "client_max_datagrams" in obj:
            obj["clientMaxDatagrams"] = obj["client_max_datagrams"]
        obj.pop("client_max_datagrams", None)
        ...
        if "clientUseAck2" not in obj and "client_use_ack2" in obj:
            obj["clientUseAck2"] = obj["client_use_ack2"]
        obj.pop("client_use_ack2", None)
        ...
        if "enableVRCPlusWorldLists" not in obj and "enable_vrc_plus_world_lists" in obj:
            obj["enableVRCPlusWorldLists"] = obj["enable_vrc_plus_world_lists"]
        obj.pop("enable_vrc_plus_world_lists", None)
        if "eventShelfCampaigns" not in obj and "event_shelf_campaigns" in obj:
            obj["eventShelfCampaigns"] = obj["event_shelf_campaigns"]
        obj.pop("event_shelf_campaigns", None)
        ...
        if "globalCacheVersion" not in obj and "global_cache_version" in obj:
            obj["globalCacheVersion"] = obj["global_cache_version"]
        obj.pop("global_cache_version", None)
        if "globalCacheVersionDefault" not in obj and "global_cache_version_default" in obj:
            obj["globalCacheVersionDefault"] = obj["global_cache_version_default"]
        obj.pop("global_cache_version_default", None)
        ...
        if "googleApiUnityClientId" not in obj and "google_api_unity_client_id" in obj:
            obj["googleApiUnityClientId"] = obj["google_api_unity_client_id"]
        obj.pop("google_api_unity_client_id", None)
        ...
        if "loadingScreenWeights" not in obj and "loading_screen_weights" in obj:
            obj["loadingScreenWeights"] = obj["loading_screen_weights"]
        obj.pop("loading_screen_weights", None)
        if "lowMemoryGoHomeTimeout" not in obj and "low_memory_go_home_timeout" in obj:
            obj["lowMemoryGoHomeTimeout"] = obj["low_memory_go_home_timeout"]
        obj.pop("low_memory_go_home_timeout", None)
        ...
        if "maximumUnityVersionForUploads" not in obj and "maximum_unity_version_for_uploads" in obj:
            obj["maximumUnityVersionForUploads"] = obj["maximum_unity_version_for_uploads"]
        obj.pop("maximum_unity_version_for_uploads", None)
        ...
        if "player-url-resolver-sha1-gfn-override" not in obj and "player_url_resolver_sha1_gfn_override" in obj:
            obj["player-url-resolver-sha1-gfn-override"] = obj["player_url_resolver_sha1_gfn_override"]
        obj.pop("player_url_resolver_sha1_gfn_override", None)
        ...
        if "player-url-resolver-version-gfn-override" not in obj and "player_url_resolver_version_gfn_override" in obj:
            obj["player-url-resolver-version-gfn-override"] = obj["player_url_resolver_version_gfn_override"]
        obj.pop("player_url_resolver_version_gfn_override", None)
        if "profileDefaults" not in obj and "profile_defaults" in obj:
            obj["profileDefaults"] = obj["profile_defaults"]
        obj.pop("profile_defaults", None)
        if "propComponentList" not in obj and "prop_component_list" in obj:
            obj["propComponentList"] = obj["prop_component_list"]
        obj.pop("prop_component_list", None)
        if "publicKey" not in obj and "public_key" in obj:
            obj["publicKey"] = obj["public_key"]
        obj.pop("public_key", None)
        if "questMinimumLowMemoryThreshold" not in obj and "quest_minimum_low_memory_threshold" in obj:
            obj["questMinimumLowMemoryThreshold"] = obj["quest_minimum_low_memory_threshold"]
        obj.pop("quest_minimum_low_memory_threshold", None)
        ...
        if "voiceMaxPlaybackSourcesMobile" not in obj and "voice_max_playback_sources_mobile" in obj:
            obj["voiceMaxPlaybackSourcesMobile"] = obj["voice_max_playback_sources_mobile"]
        obj.pop("voice_max_playback_sources_mobile", None)
        if "voiceMaxPlaybackSourcesPC" not in obj and "voice_max_playback_sources_pc" in obj:
            obj["voiceMaxPlaybackSourcesPC"] = obj["voice_max_playback_sources_pc"]
        obj.pop("voice_max_playback_sources_pc", None)
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("clientMaxDatagrams" if serialize else "client_max_datagrams"): _to_legacy_value(getattr(self, "client_max_datagrams", None), serialize),
            ...
            ("clientUseAck2" if serialize else "client_use_ack2"): _to_legacy_value(getattr(self, "client_use_ack2", None), serialize),
            ...
            ("enableVRCPlusWorldLists" if serialize else "enable_vrc_plus_world_lists"): _to_legacy_value(getattr(self, "enable_vrc_plus_world_lists", None), serialize),
            ("eventShelfCampaigns" if serialize else "event_shelf_campaigns"): _to_legacy_value(getattr(self, "event_shelf_campaigns", None), serialize),
            ...
            ("globalCacheVersion" if serialize else "global_cache_version"): _to_legacy_value(getattr(self, "global_cache_version", None), serialize),
            ("globalCacheVersionDefault" if serialize else "global_cache_version_default"): _to_legacy_value(getattr(self, "global_cache_version_default", None), serialize),
            ...
            ("googleApiUnityClientId" if serialize else "google_api_unity_client_id"): _to_legacy_value(getattr(self, "google_api_unity_client_id", None), serialize),
            ...
            ("loadingScreenWeights" if serialize else "loading_screen_weights"): _to_legacy_value(getattr(self, "loading_screen_weights", None), serialize),
            ("lowMemoryGoHomeTimeout" if serialize else "low_memory_go_home_timeout"): _to_legacy_value(getattr(self, "low_memory_go_home_timeout", None), serialize),
            ...
            ("maximumUnityVersionForUploads" if serialize else "maximum_unity_version_for_uploads"): _to_legacy_value(getattr(self, "maximum_unity_version_for_uploads", None), serialize),
            ...
            ("player-url-resolver-sha1-gfn-override" if serialize else "player_url_resolver_sha1_gfn_override"): _to_legacy_value(getattr(self, "player_url_resolver_sha1_gfn_override", None), serialize),
            ...
            ("player-url-resolver-version-gfn-override" if serialize else "player_url_resolver_version_gfn_override"): _to_legacy_value(getattr(self, "player_url_resolver_version_gfn_override", None), serialize),
            ("profileDefaults" if serialize else "profile_defaults"): _to_legacy_value(getattr(self, "profile_defaults", None), serialize),
            ("propComponentList" if serialize else "prop_component_list"): _to_legacy_value(getattr(self, "prop_component_list", None), serialize),
            ("publicKey" if serialize else "public_key"): _to_legacy_value(getattr(self, "public_key", None), serialize),
            ("questMinimumLowMemoryThreshold" if serialize else "quest_minimum_low_memory_threshold"): _to_legacy_value(getattr(self, "quest_minimum_low_memory_threshold", None), serialize),
            ...
            ("voiceMaxPlaybackSourcesMobile" if serialize else "voice_max_playback_sources_mobile"): _to_legacy_value(getattr(self, "voice_max_playback_sources_mobile", None), serialize),
            ("voiceMaxPlaybackSourcesPC" if serialize else "voice_max_playback_sources_pc"): _to_legacy_value(getattr(self, "voice_max_playback_sources_pc", None), serialize),
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in event_shelf_campaigns (list)
        _items = []
        if self.event_shelf_campaigns:
            for _item_event_shelf_campaigns in self.event_shelf_campaigns:
                if _item_event_shelf_campaigns:
                    _items.append(_to_openapi_value(_item_event_shelf_campaigns))
            _dict['eventShelfCampaigns'] = _items
        ...
        # override the default output from pydantic by calling `to_dict()` of each value in loading_screen_weights (dict)
        _field_dict = {}
        if self.loading_screen_weights:
            for _key_loading_screen_weights in self.loading_screen_weights:
                if self.loading_screen_weights[_key_loading_screen_weights]:
                    _field_dict[_key_loading_screen_weights] = _to_openapi_value(self.loading_screen_weights[_key_loading_screen_weights])
            _dict['loadingScreenWeights'] = _field_dict
        # override the default output from pydantic by calling `to_dict()` of each value in low_memory_go_home_timeout (dict)
        _field_dict = {}
        if self.low_memory_go_home_timeout:
            for _key_low_memory_go_home_timeout in self.low_memory_go_home_timeout:
                if self.low_memory_go_home_timeout[_key_low_memory_go_home_timeout]:
                    _field_dict[_key_low_memory_go_home_timeout] = _to_openapi_value(self.low_memory_go_home_timeout[_key_low_memory_go_home_timeout])
            _dict['lowMemoryGoHomeTimeout'] = _field_dict
        ...
        # override the default output from pydantic by calling `to_dict()` of profile_defaults
        if self.profile_defaults:
            _dict['profileDefaults'] = _to_openapi_value(self.profile_defaults)
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "clientMaxDatagrams": obj.get("clientMaxDatagrams"),
            ...
            "clientUseAck2": obj.get("clientUseAck2"),
            ...
            "enableVRCPlusWorldLists": obj.get("enableVRCPlusWorldLists"),
            "eventShelfCampaigns": [APIConfigEventShelfCampaign.from_dict(_item) for _item in obj["eventShelfCampaigns"]] if obj.get("eventShelfCampaigns") is not None else None,
            ...
            "globalCacheVersion": obj.get("globalCacheVersion"),
            "globalCacheVersionDefault": obj.get("globalCacheVersionDefault"),
            ...
            "googleApiUnityClientId": obj.get("googleApiUnityClientId"),
            ...
            "loadingScreenWeights": dict(
                (_k, APIConfigLoadingScreenWeights.from_dict(_v))
                for _k, _v in obj["loadingScreenWeights"].items()
            )
            if obj.get("loadingScreenWeights") is not None
            else None,
            "lowMemoryGoHomeTimeout": dict(
                (_k, APIConfigLowMemoryGoHomeTimeoutValue.from_dict(_v))
                for _k, _v in obj["lowMemoryGoHomeTimeout"].items()
            )
            if obj.get("lowMemoryGoHomeTimeout") is not None
            else None,
            ...
            "maximumUnityVersionForUploads": obj.get("maximumUnityVersionForUploads"),
            ...
            "player-url-resolver-sha1-gfn-override": obj.get("player-url-resolver-sha1-gfn-override"),
            "player-url-resolver-version": obj.get("player-url-resolver-version"),
            "player-url-resolver-version-gfn-override": obj.get("player-url-resolver-version-gfn-override"),
            "profileDefaults": APIConfigProfileDefaults.from_dict(obj["profileDefaults"]) if obj.get("profileDefaults") is not None else None,
            "propComponentList": obj.get("propComponentList"),
            "publicKey": obj.get("publicKey"),
            "questMinimumLowMemoryThreshold": obj.get("questMinimumLowMemoryThreshold"),
            ...
            "voiceMaxPlaybackSourcesMobile": obj.get("voiceMaxPlaybackSourcesMobile"),
            "voiceMaxPlaybackSourcesPC": obj.get("voiceMaxPlaybackSourcesPC"),
