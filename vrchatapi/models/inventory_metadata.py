...
class InventoryMetadata(BaseModel):
    ...
    prop_kind: Optional[StrictInt] = Field(default=None, validation_alias=AliasChoices("propKind", "prop_kind"), serialization_alias="propKind")
    viewfinder_bundle_id: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("viewfinderBundleId", "viewfinder_bundle_id"), serialization_alias="viewfinderBundleId")
    ...
    __properties: ClassVar[List[str]] = ["animated", "animationStyle", "assetBundleId", "assets", "fileId", "gradientEnd", "gradientStart", "imageUrl", "inventoryItemsToInstantiate", "maskTag", "propId", "propKind", "viewfinderBundleId"]
    ...
    def __preprocess_input_names(
        ...
        if "gradientEnd" not in obj and "gradient_end" in obj:
            obj["gradientEnd"] = obj["gradient_end"]
        obj.pop("gradient_end", None)
        if "gradientStart" not in obj and "gradient_start" in obj:
            obj["gradientStart"] = obj["gradient_start"]
        obj.pop("gradient_start", None)
        ...
        if "propKind" not in obj and "prop_kind" in obj:
            obj["propKind"] = obj["prop_kind"]
        obj.pop("prop_kind", None)
        if "viewfinderBundleId" not in obj and "viewfinder_bundle_id" in obj:
            obj["viewfinderBundleId"] = obj["viewfinder_bundle_id"]
        obj.pop("viewfinder_bundle_id", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("assets" if serialize else "assets"): _to_legacy_value(getattr(self, "assets", None), serialize),
            ("fileId" if serialize else "file_id"): _to_legacy_value(getattr(self, "file_id", None), serialize),
            ("gradientEnd" if serialize else "gradient_end"): _to_legacy_value(getattr(self, "gradient_end", None), serialize),
            ("gradientStart" if serialize else "gradient_start"): _to_legacy_value(getattr(self, "gradient_start", None), serialize),
            ...
            ("propKind" if serialize else "prop_kind"): _to_legacy_value(getattr(self, "prop_kind", None), serialize),
            ("viewfinderBundleId" if serialize else "viewfinder_bundle_id"): _to_legacy_value(getattr(self, "viewfinder_bundle_id", None), serialize),
        }
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.assets:
            for _item_assets in self.assets:
                if _item_assets:
                    _items.append(_to_openapi_value(_item_assets))
            _dict['assets'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "assets": [InventoryAsset.from_dict(_item) for _item in obj["assets"]] if obj.get("assets") is not None else None,
            "fileId": obj.get("fileId"),
            "gradientEnd": obj.get("gradientEnd"),
            "gradientStart": obj.get("gradientStart"),
            "imageUrl": obj.get("imageUrl"),
            "inventoryItemsToInstantiate": obj.get("inventoryItemsToInstantiate"),
            "maskTag": obj.get("maskTag"),
            "propId": obj.get("propId"),
            "propKind": obj.get("propKind"),
            "viewfinderBundleId": obj.get("viewfinderBundleId")
        })
        return _obj
