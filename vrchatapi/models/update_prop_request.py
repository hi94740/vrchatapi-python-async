...
class UpdatePropRequest(BaseModel):
    ...
    spawn_type: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=1, validation_alias=AliasChoices("spawnType", "spawn_type"), serialization_alias="spawnType", description="How a prop is summoned and interacted with. 0: the prop fixed to some surface in the world 1: the prop is a pickup and may be held by users 2: ???")
    ...
    __properties: ClassVar[List[str]] = ["assetUrl", "assetVersion", "description", "imageUrl", "name", "platform", "propSignature", "spawnType", "tags", "unityVersion", "worldPlacementMask"]
