...
class GroupMemberLimitedUser(BaseModel):
    ...
    current_avatar_thumbnail_image_url: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("currentAvatarThumbnailImageUrl", "current_avatar_thumbnail_image_url"), serialization_alias="currentAvatarThumbnailImageUrl")
    ...
    thumbnail_url: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("thumbnailUrl", "thumbnail_url"), serialization_alias="thumbnailUrl")
    ...
    __properties: ClassVar[List[str]] = ["currentAvatarTags", "currentAvatarThumbnailImageUrl", "displayName", "iconUrl", "id", "profilePicOverride", "thumbnailUrl"]
    ...
    def __preprocess_input_names(
        ...
        if "thumbnailUrl" not in obj and "thumbnail_url" in obj:
            obj["thumbnailUrl"] = obj["thumbnail_url"]
        obj.pop("thumbnail_url", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("thumbnailUrl" if serialize else "thumbnail_url"): _to_legacy_value(getattr(self, "thumbnail_url", None), serialize),
        }
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if current_avatar_thumbnail_image_url (nullable) is None
        # and model_fields_set contains the field
        if self.current_avatar_thumbnail_image_url is None and "current_avatar_thumbnail_image_url" in self.model_fields_set:
            _dict['currentAvatarThumbnailImageUrl'] = None
