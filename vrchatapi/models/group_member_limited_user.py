...
class GroupMemberLimitedUser(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["bannerColor", "bannerType", "bannerUrl", "displayName", "iconFrame", "iconUrl", "id", "nameplateEffect", "profileEffect"]
