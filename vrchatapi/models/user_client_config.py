...
class UserClientConfig(BaseModel):
    """
    UserClientConfig
    ...
    """ # noqa: E501
    access_reduce_decor_anim: Optional[StrictBool] = Field(default=None, validation_alias=AliasChoices("accessReduceDecorAnim", "access_reduce_decor_anim"), serialization_alias="accessReduceDecorAnim")
    config_string: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("configString", "config_string"), serialization_alias="configString")
    ...
    __properties: ClassVar[List[str]] = ["accessReduceDecorAnim", "configString"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "accessReduceDecorAnim" not in obj and "access_reduce_decor_anim" in obj:
            obj["accessReduceDecorAnim"] = obj["access_reduce_decor_anim"]
        obj.pop("access_reduce_decor_anim", None)
        if "configString" not in obj and "config_string" in obj:
            obj["configString"] = obj["config_string"]
        obj.pop("config_string", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("accessReduceDecorAnim" if serialize else "access_reduce_decor_anim"): _to_legacy_value(getattr(self, "access_reduce_decor_anim", None), serialize),
            ("configString" if serialize else "config_string"): _to_legacy_value(getattr(self, "config_string", None), serialize),
        }
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accessReduceDecorAnim": obj.get("accessReduceDecorAnim"),
