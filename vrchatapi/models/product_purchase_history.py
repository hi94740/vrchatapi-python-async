...
class ProductPurchaseHistory(BaseModel):
    ...
    transactions: Optional[List[ProductPurchaseRecord]] = None
    ...
    __properties: ClassVar[List[str]] = ["endDate", "startDate", "transactions"]
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("transactions" if serialize else "transactions"): _to_legacy_value(getattr(self, "transactions", None), serialize),
        }
        ...
        if self.transactions:
            for _item_transactions in self.transactions:
                if _item_transactions:
                    _items.append(_to_openapi_value(_item_transactions))
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "transactions": [ProductPurchaseRecord.from_dict(_item) for _item in obj["transactions"]] if obj.get("transactions") is not None else None
        })
        return _obj
