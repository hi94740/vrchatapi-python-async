...
class UpdateGroupMemberRequest(BaseModel):
    ...
    visibility: Optional[GroupUserVisibility] = None
    ...
    __properties: ClassVar[List[str]] = ["isSubscribedToAnnouncements", "isSubscribedToEventAnnouncements", "managerNotes", "visibility"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "isSubscribedToAnnouncements": obj.get("isSubscribedToAnnouncements"),
