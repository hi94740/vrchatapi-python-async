...
class InstanceCategory(BaseModel):
    ...
    icon_url: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("iconUrl", "icon_url"), serialization_alias="iconUrl", json_schema_extra={"examples": ["vrchat://category_hangout"]})
    id: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["icat_44bc6a70-493f-4f84-8a3b-1f290c864c2a"]})
    name: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["Hangout"]})
    order: Optional[StrictInt] = Field(default=None, json_schema_extra={"examples": [0]})
    ...
    __properties: ClassVar[List[str]] = ["deleted", "iconUrl", "id", "name", "order"]
