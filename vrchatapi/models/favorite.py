...
class Favorite(BaseModel):
    ...
    """ # noqa: E501
    favorite_id: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("favoriteId", "favorite_id"), serialization_alias="favoriteId", description="MUST be either AvatarID, UserID or WorldID.")
    id: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["fvrt_9568d189-8776-44a5-a8c8-defc981e44de"]})
    ...
    __properties: ClassVar[List[str]] = ["favoriteId", "id", "tags", "type"]
