...
class FriendStatus(BaseModel):
    ...
    """ # noqa: E501
    incoming_request: Optional[StrictBool] = Field(default=None, validation_alias=AliasChoices("incomingRequest", "incoming_request"), serialization_alias="incomingRequest")
    ...
    outgoing_request: Optional[StrictBool] = Field(default=None, validation_alias=AliasChoices("outgoingRequest", "outgoing_request"), serialization_alias="outgoingRequest")
    ...
    __properties: ClassVar[List[str]] = ["incomingRequest", "isFriend", "outgoingRequest"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "incomingRequest" not in obj and "incoming_request" in obj:
            obj["incomingRequest"] = obj["incoming_request"]
        obj.pop("incoming_request", None)
        if "isFriend" not in obj and "is_friend" in obj:
            obj["isFriend"] = obj["is_friend"]
        obj.pop("is_friend", None)
        if "outgoingRequest" not in obj and "outgoing_request" in obj:
            obj["outgoingRequest"] = obj["outgoing_request"]
        obj.pop("outgoing_request", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("incomingRequest" if serialize else "incoming_request"): _to_legacy_value(getattr(self, "incoming_request", None), serialize),
            ("isFriend" if serialize else "is_friend"): _to_legacy_value(getattr(self, "is_friend", None), serialize),
            ("outgoingRequest" if serialize else "outgoing_request"): _to_legacy_value(getattr(self, "outgoing_request", None), serialize),
        }
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "incomingRequest": obj.get("incomingRequest") if obj.get("incomingRequest") is not None else False,
            "isFriend": obj.get("isFriend") if obj.get("isFriend") is not None else False,
            "outgoingRequest": obj.get("outgoingRequest") if obj.get("outgoingRequest") is not None else False
        })
        return _obj
