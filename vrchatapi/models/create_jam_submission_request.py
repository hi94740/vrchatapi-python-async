...
class CreateJamSubmissionRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    content_id: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("contentId", "content_id"), serialization_alias="contentId", description="The id of the uploaded content (e.g., avatar, world) being submitted.", json_schema_extra={"examples": ["avtr_c38a1615-5bf5-42b4-84eb-a8b6c37cbd11"]})
    description: Optional[StrictStr] = Field(default=None, description="A description of the content being submitted.", json_schema_extra={"examples": ["My awesomely unique avatar for the jam!"]})
    ...
    __properties: ClassVar[List[str]] = ["contentId", "description"]
