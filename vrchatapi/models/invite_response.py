...
class InviteResponse(BaseModel):
    ...
    """ # noqa: E501
    response_slot: Optional[Annotated[int, Field(le=11, strict=True, ge=0)]] = Field(default=None, validation_alias=AliasChoices("responseSlot", "response_slot"), serialization_alias="responseSlot")
    ...
    __properties: ClassVar[List[str]] = ["responseSlot"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "responseSlot" not in obj and "response_slot" in obj:
            obj["responseSlot"] = obj["response_slot"]
        obj.pop("response_slot", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("responseSlot" if serialize else "response_slot"): _to_legacy_value(getattr(self, "response_slot", None), serialize),
        }
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "responseSlot": obj.get("responseSlot")
        })
        return _obj
