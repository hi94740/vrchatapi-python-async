...
class BetaUserField(BaseModel):
    ...
    """ # noqa: E501
    allowed_values: Optional[List[StrictStr]] = Field(default=None, validation_alias=AliasChoices("allowedValues", "allowed_values"), serialization_alias="allowedValues")
    exclude_from_analytics: Optional[StrictBool] = Field(default=None, validation_alias=AliasChoices("excludeFromAnalytics", "exclude_from_analytics"), serialization_alias="excludeFromAnalytics")
    ...
    __properties: ClassVar[List[str]] = ["allowedValues", "excludeFromAnalytics", "required"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "allowedValues" not in obj and "allowed_values" in obj:
            obj["allowedValues"] = obj["allowed_values"]
        obj.pop("allowed_values", None)
        if "excludeFromAnalytics" not in obj and "exclude_from_analytics" in obj:
            obj["excludeFromAnalytics"] = obj["exclude_from_analytics"]
        obj.pop("exclude_from_analytics", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("allowedValues" if serialize else "allowed_values"): _to_legacy_value(getattr(self, "allowed_values", None), serialize),
            ("excludeFromAnalytics" if serialize else "exclude_from_analytics"): _to_legacy_value(getattr(self, "exclude_from_analytics", None), serialize),
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "excludeFromAnalytics": obj.get("excludeFromAnalytics"),
