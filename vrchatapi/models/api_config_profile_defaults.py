...
class APIConfigProfileDefaults(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["backgroundGradientBottom", "backgroundGradientTop", "themeButtonColor", "themeIconColor", "themeSubtextColor"]
