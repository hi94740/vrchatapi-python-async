...
class NotificationV2Response(BaseModel):
    ...
    icon: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["Bell:\n  value: bell\nBell Slash:\n  value: bell-slash\nCheck:\n  value: check\n"]})
    text: Optional[StrictStr] = None
    text_key: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("textKey", "text_key"), serialization_alias="textKey")
    type: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["Accept:\n  value: accept\nBoop:\n  value: boop\nDecline:\n  value: decline\nDelete:\n  value: delete\nUnsubscribe:\n  value: unsubscribe\n"]})
    ...
    __properties: ClassVar[List[str]] = ["data", "icon", "text", "textKey", "type"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "textKey" not in obj and "text_key" in obj:
            obj["textKey"] = obj["text_key"]
        obj.pop("text_key", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("icon" if serialize else "icon"): _to_legacy_value(getattr(self, "icon", None), serialize),
            ("text" if serialize else "text"): _to_legacy_value(getattr(self, "text", None), serialize),
            ("textKey" if serialize else "text_key"): _to_legacy_value(getattr(self, "text_key", None), serialize),
