...
class FinishFileDataUploadRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    etags: Optional[Annotated[List[StrictStr], Field(min_length=1)]] = Field(default=None, description="Array of ETags uploaded.")
    max_parts: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=1)]] = Field(default=None, validation_alias=AliasChoices("maxParts", "max_parts"), serialization_alias="maxParts", description="Always a zero in string form, despite how many parts uploaded.", json_schema_extra={"examples": ["0"]})
    next_part_number: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=1)]] = Field(default=None, validation_alias=AliasChoices("nextPartNumber", "next_part_number"), serialization_alias="nextPartNumber", description="Always a zero in string form, despite how many parts uploaded.", json_schema_extra={"examples": ["0"]})
    ...
    __properties: ClassVar[List[str]] = ["etags", "maxParts", "nextPartNumber"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "etags": obj.get("etags"),
            "maxParts": obj.get("maxParts") if obj.get("maxParts") is not None else '0',
            "nextPartNumber": obj.get("nextPartNumber") if obj.get("nextPartNumber") is not None else '0'
        })
        return _obj
