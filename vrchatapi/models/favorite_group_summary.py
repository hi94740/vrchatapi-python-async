...
class FavoriteGroupSummary(BaseModel):
    ...
    num_favorites: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, validation_alias=AliasChoices("numFavorites", "num_favorites"), serialization_alias="numFavorites")
    ...
    __properties: ClassVar[List[str]] = ["displayName", "id", "name", "numFavorites", "visibility"]
    ...
    def __preprocess_input_names(
        ...
        if "numFavorites" not in obj and "num_favorites" in obj:
            obj["numFavorites"] = obj["num_favorites"]
        obj.pop("num_favorites", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("numFavorites" if serialize else "num_favorites"): _to_legacy_value(getattr(self, "num_favorites", None), serialize),
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "name": obj.get("name"),
            "numFavorites": obj.get("numFavorites"),
