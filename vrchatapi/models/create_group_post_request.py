...
class CreateGroupPostRequest(BaseModel):
    ...
    send_notification: Optional[StrictBool] = Field(default=None, validation_alias=AliasChoices("sendNotification", "send_notification"), serialization_alias="sendNotification", description="Send notification to group members.", json_schema_extra={"examples": [False]})
    text: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, description="Post text", json_schema_extra={"examples": ["Come join us for the event!"]})
    title: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, description="Post title", json_schema_extra={"examples": ["Event is starting soon!"]})
    ...
    __properties: ClassVar[List[str]] = ["imageId", "roleIds", "sendNotification", "text", "title", "visibility"]
    ...
    def __preprocess_input_names(
        ...
        if "sendNotification" not in obj and "send_notification" in obj:
            obj["sendNotification"] = obj["send_notification"]
        obj.pop("send_notification", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("sendNotification" if serialize else "send_notification"): _to_legacy_value(getattr(self, "send_notification", None), serialize),
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sendNotification": obj.get("sendNotification") if obj.get("sendNotification") is not None else False,
            "text": obj.get("text"),
            "title": obj.get("title"),
