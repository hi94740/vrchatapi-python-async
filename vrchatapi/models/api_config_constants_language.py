...
class APIConfigConstantsLANGUAGE(BaseModel):
    """
    ...
    """ # noqa: E501
    spoken_language_options: Optional[Dict[str, StrictStr]] = Field(default=None, validation_alias=AliasChoices("SPOKEN_LANGUAGE_OPTIONS", "spoken_language_options"), serialization_alias="SPOKEN_LANGUAGE_OPTIONS", description="Supported spoken language options")
    ...
    __properties: ClassVar[List[str]] = ["SPOKEN_LANGUAGE_OPTIONS"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "SPOKEN_LANGUAGE_OPTIONS" not in obj and "spoken_language_options" in obj:
            obj["SPOKEN_LANGUAGE_OPTIONS"] = obj["spoken_language_options"]
        obj.pop("spoken_language_options", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("SPOKEN_LANGUAGE_OPTIONS" if serialize else "spoken_language_options"): _to_legacy_value(getattr(self, "spoken_language_options", None), serialize),
        }
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "SPOKEN_LANGUAGE_OPTIONS": obj.get("SPOKEN_LANGUAGE_OPTIONS")
        })
        return _obj
