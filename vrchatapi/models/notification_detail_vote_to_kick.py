...
class NotificationDetailVoteToKick(BaseModel):
    """
    ...
    """ # noqa: E501
    initiator_user_id: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("initiatorUserId", "initiator_user_id"), serialization_alias="initiatorUserId", description="A users unique ID, usually in the form of `usr_c1644b5b-3ca4-45b4-97c6-a2a0de70d469`. Legacy players can have old IDs in the form of `8JoV9XEdpo`. The ID can never be changed.", json_schema_extra={"examples": ["usr_c1644b5b-3ca4-45b4-97c6-a2a0de70d469"]})
    user_to_kick_id: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("userToKickId", "user_to_kick_id"), serialization_alias="userToKickId", description="A users unique ID, usually in the form of `usr_c1644b5b-3ca4-45b4-97c6-a2a0de70d469`. Legacy players can have old IDs in the form of `8JoV9XEdpo`. The ID can never be changed.", json_schema_extra={"examples": ["usr_c1644b5b-3ca4-45b4-97c6-a2a0de70d469"]})
    ...
    __properties: ClassVar[List[str]] = ["initiatorUserId", "userToKickId"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "initiatorUserId" not in obj and "initiator_user_id" in obj:
            obj["initiatorUserId"] = obj["initiator_user_id"]
        obj.pop("initiator_user_id", None)
        if "userToKickId" not in obj and "user_to_kick_id" in obj:
            obj["userToKickId"] = obj["user_to_kick_id"]
        obj.pop("user_to_kick_id", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("initiatorUserId" if serialize else "initiator_user_id"): _to_legacy_value(getattr(self, "initiator_user_id", None), serialize),
            ("userToKickId" if serialize else "user_to_kick_id"): _to_legacy_value(getattr(self, "user_to_kick_id", None), serialize),
        }
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "initiatorUserId": obj.get("initiatorUserId"),
            "userToKickId": obj.get("userToKickId")
        })
        return _obj
