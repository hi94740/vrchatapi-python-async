...
class EarningsMetrics(BaseModel):
    ...
    totals: Optional[EarningsMetricsTotals] = None
    ...
    __properties: ClassVar[List[str]] = ["breakdown", "sellerId", "totals"]
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("breakdown" if serialize else "breakdown"): _to_legacy_value(getattr(self, "breakdown", None), serialize),
            ("sellerId" if serialize else "seller_id"): _to_legacy_value(getattr(self, "seller_id", None), serialize),
            ("totals" if serialize else "totals"): _to_legacy_value(getattr(self, "totals", None), serialize),
        }
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.totals:
            _dict['totals'] = _to_openapi_value(self.totals)
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "totals": EarningsMetricsTotals.from_dict(obj["totals"]) if obj.get("totals") is not None else None
        })
        return _obj
