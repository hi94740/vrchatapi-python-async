...
class Disable2FAResult(BaseModel):
    """
    Disable2FAResult
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Disable2FAResult from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        """Return all declared model fields using public or wire names."""
        return {
            ("removed" if serialize else "removed"): _to_legacy_value(getattr(self, "removed", None), serialize),
        }
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Disable2FAResult from a dict"""
        if obj is None:
            return None
