...
class AvatarModerationCreated(BaseModel):
    """
    ...
    """ # noqa: E501
    avatar_moderation_type: Optional[AvatarModerationType] = Field(default=None, validation_alias=AliasChoices("avatarModerationType", "avatar_moderation_type"), serialization_alias="avatarModerationType")
    created: Optional[StrictInt] = Field(default=None, description="Timestamp in milliseconds since Unix epoch")
    target_avatar_id: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("targetAvatarId", "target_avatar_id"), serialization_alias="targetAvatarId", json_schema_extra={"examples": ["avtr_912d66a4-4714-43b8-8407-7de2cafbf55b"]})
    ...
    __properties: ClassVar[List[str]] = ["avatarModerationType", "created", "targetAvatarId"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "avatarModerationType" not in obj and "avatar_moderation_type" in obj:
            obj["avatarModerationType"] = obj["avatar_moderation_type"]
        obj.pop("avatar_moderation_type", None)
        if "targetAvatarId" not in obj and "target_avatar_id" in obj:
            obj["targetAvatarId"] = obj["target_avatar_id"]
        obj.pop("target_avatar_id", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("avatarModerationType" if serialize else "avatar_moderation_type"): _to_legacy_value(getattr(self, "avatar_moderation_type", None), serialize),
            ("created" if serialize else "created"): _to_legacy_value(getattr(self, "created", None), serialize),
            ("targetAvatarId" if serialize else "target_avatar_id"): _to_legacy_value(getattr(self, "target_avatar_id", None), serialize),
        }
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "avatarModerationType": obj.get("avatarModerationType"),
            "created": obj.get("created"),
            "targetAvatarId": obj.get("targetAvatarId")
        })
        return _obj
