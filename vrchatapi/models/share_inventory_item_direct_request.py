...
class ShareInventoryItemDirectRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    item_id: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("itemId", "item_id"), serialization_alias="itemId", json_schema_extra={"examples": ["inv_10bce5b0-2d2b-44e0-900d-db6534615162"]})
    ...
    __properties: ClassVar[List[str]] = ["itemId", "users"]
