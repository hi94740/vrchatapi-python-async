...
class PerformanceLimiterInfo(BaseModel):
    """
    ...
    """ # noqa: E501
    max_seats: Optional[StrictInt] = Field(default=None, validation_alias=AliasChoices("maxSeats", "max_seats"), serialization_alias="maxSeats", description="Maximum amount of seats. -1 means no limit.")
    ...
    __properties: ClassVar[List[str]] = ["maxSeats"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "maxSeats" not in obj and "max_seats" in obj:
            obj["maxSeats"] = obj["max_seats"]
        obj.pop("max_seats", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("maxSeats" if serialize else "max_seats"): _to_legacy_value(getattr(self, "max_seats", None), serialize),
        }
