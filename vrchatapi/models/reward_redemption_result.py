...
class RewardRedemptionResult(BaseModel):
    """
    ...
    """ # noqa: E501
    redeemed_rewards: Optional[List[RewardRedemption]] = Field(default=None, validation_alias=AliasChoices("redeemedRewards", "redeemed_rewards"), serialization_alias="redeemedRewards")
    redemption_code: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("redemptionCode", "redemption_code"), serialization_alias="redemptionCode")
    ...
    __properties: ClassVar[List[str]] = ["redeemedRewards", "redemptionCode"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "redeemedRewards" not in obj and "redeemed_rewards" in obj:
            obj["redeemedRewards"] = obj["redeemed_rewards"]
        obj.pop("redeemed_rewards", None)
        if "redemptionCode" not in obj and "redemption_code" in obj:
            obj["redemptionCode"] = obj["redemption_code"]
        obj.pop("redemption_code", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("redeemedRewards" if serialize else "redeemed_rewards"): _to_legacy_value(getattr(self, "redeemed_rewards", None), serialize),
            ("redemptionCode" if serialize else "redemption_code"): _to_legacy_value(getattr(self, "redemption_code", None), serialize),
        }
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in redeemed_rewards (list)
        _items = []
        if self.redeemed_rewards:
            for _item_redeemed_rewards in self.redeemed_rewards:
                if _item_redeemed_rewards:
                    _items.append(_to_openapi_value(_item_redeemed_rewards))
            _dict['redeemedRewards'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "redeemedRewards": [RewardRedemption.from_dict(_item) for _item in obj["redeemedRewards"]] if obj.get("redeemedRewards") is not None else None,
