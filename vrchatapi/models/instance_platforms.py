...
class InstancePlatforms(BaseModel):
    """
    InstancePlatforms
    ...
    """ # noqa: E501
    android: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, json_schema_extra={"examples": [1]})
    ios: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, json_schema_extra={"examples": [1]})
    standalonewindows: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, json_schema_extra={"examples": [5]})
    ...
    __properties: ClassVar[List[str]] = ["android", "ios", "standalonewindows"]
