...
class ProductPurchasePurchaseContext(BaseModel):
    """
    ...
    """ # noqa: E501
    location_type: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("locationType", "location_type"), serialization_alias="locationType", json_schema_extra={"examples": ["undefined"]})
    ...
    __properties: ClassVar[List[str]] = ["locationType", "worldId", "worldName"]
