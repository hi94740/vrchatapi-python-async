...
class ProductListingAttributionCreator(BaseModel):
    """
    ...
    """ # noqa: E501
    custom_name: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("customName", "custom_name"), serialization_alias="customName")
    ...
    __properties: ClassVar[List[str]] = ["customName", "userId"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "customName" not in obj and "custom_name" in obj:
            obj["customName"] = obj["custom_name"]
        obj.pop("custom_name", None)
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("customName" if serialize else "custom_name"): _to_legacy_value(getattr(self, "custom_name", None), serialize),
