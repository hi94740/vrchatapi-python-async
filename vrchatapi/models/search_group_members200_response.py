...
class SearchGroupMembers200Response(BaseModel):
    """
    ...
    """ # noqa: E501
    results: Optional[List[Optional[GroupMember]]] = None
    total: Optional[StrictInt] = Field(default=None, description="Number of members returned")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [GroupMember.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
            "total": obj.get("total")
        })
        return _obj
