...
class ChangeWorldTagsRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    tags: Optional[List[Annotated[str, Field(min_length=1, strict=True)]]] = Field(default=None, description="The tags being added or removed.")
