...
class InfoPushIpsQuery(BaseModel):
    """
    InfoPushIpsQuery
    ...
    require: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["include", "require"]
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("include" if serialize else "include"): _to_legacy_value(getattr(self, "include", None), serialize),
            ("require" if serialize else "require"): _to_legacy_value(getattr(self, "require", None), serialize),
        }
