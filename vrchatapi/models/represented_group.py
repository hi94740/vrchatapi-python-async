...
class RepresentedGroup(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["bannerId", "bannerUrl", "description", "discriminator", "groupId", "iconId", "iconUrl", "isRepresenting", "memberCount", "memberVisibility", "name", "nameplateId", "nameplateUrl", "ownerId", "privacy", "shortCode"]
