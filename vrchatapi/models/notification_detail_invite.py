...
class NotificationDetailInvite(BaseModel):
    """
    ...
    """ # noqa: E501
    invite_message: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("inviteMessage", "invite_message"), serialization_alias="inviteMessage")
    world_id: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("worldId", "world_id"), serialization_alias="worldId", description="Represents a unique location, consisting of a world identifier and an instance identifier, or \"offline\" if the user is not on your friends list.", json_schema_extra={"examples": ["wrld_4432ea9b-729c-46e3-8eaf-846aa0a37fdd:12345~hidden(usr_c1644b5b-3ca4-45b4-97c6-a2a0de70d469)~region(eu)~nonce(27e8414a-59a0-4f3d-af1f-f27557eb49a2)"]})
    ...
    __properties: ClassVar[List[str]] = ["inviteMessage", "worldId", "worldName"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "inviteMessage" not in obj and "invite_message" in obj:
            obj["inviteMessage"] = obj["invite_message"]
        obj.pop("invite_message", None)
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("inviteMessage" if serialize else "invite_message"): _to_legacy_value(getattr(self, "invite_message", None), serialize),
