...
class APIConfigLoadingScreenWeights(BaseModel):
    """
    ...
    """ # noqa: E501
    announcement: Optional[StrictInt] = Field(default=None, json_schema_extra={"examples": [1]})
    informational: Optional[StrictInt] = Field(default=None, json_schema_extra={"examples": [89]})
    promotional: Optional[StrictInt] = Field(default=None, json_schema_extra={"examples": [10]})
    ...
    __properties: ClassVar[List[str]] = ["announcement", "informational", "promotional"]
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("announcement" if serialize else "announcement"): _to_legacy_value(getattr(self, "announcement", None), serialize),
            ("informational" if serialize else "informational"): _to_legacy_value(getattr(self, "informational", None), serialize),
            ("promotional" if serialize else "promotional"): _to_legacy_value(getattr(self, "promotional", None), serialize),
        }
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "promotional": obj.get("promotional")
        })
        return _obj
