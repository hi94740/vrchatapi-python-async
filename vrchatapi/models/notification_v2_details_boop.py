...
class NotificationV2DetailsBoop(BaseModel):
    """
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if emoji_version (nullable) is None
        # and model_fields_set contains the field
        if self.emoji_version is None and "emoji_version" in self.model_fields_set:
            _dict['emojiVersion'] = None
