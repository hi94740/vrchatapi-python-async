...
class InfoPushDataCategory(BaseModel):
    """
    ...
    max_cells: Optional[StrictInt] = Field(default=None, validation_alias=AliasChoices("maxCells", "max_cells"), serialization_alias="maxCells")
    ...
    __properties: ClassVar[List[str]] = ["ids", "ipsQuery", "maxCells", "name", "type"]
    ...
    def __preprocess_input_names(
        ...
        if "maxCells" not in obj and "max_cells" in obj:
            obj["maxCells"] = obj["max_cells"]
        obj.pop("max_cells", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("ids" if serialize else "ids"): _to_legacy_value(getattr(self, "ids", None), serialize),
            ("ipsQuery" if serialize else "ips_query"): _to_legacy_value(getattr(self, "ips_query", None), serialize),
            ("maxCells" if serialize else "max_cells"): _to_legacy_value(getattr(self, "max_cells", None), serialize),
