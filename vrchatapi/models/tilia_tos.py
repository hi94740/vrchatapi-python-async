...
class TiliaTOS(BaseModel):
    ...
    """ # noqa: E501
    signed_tos: Optional[StrictBool] = None
    ...
    __properties: ClassVar[List[str]] = ["signed_tos"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TiliaTOS from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        """Return all declared model fields using public or wire names."""
        return {
            ("signed_tos" if serialize else "signed_tos"): _to_legacy_value(getattr(self, "signed_tos", None), serialize),
        }
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TiliaTOS from a dict"""
        if obj is None:
            return None
