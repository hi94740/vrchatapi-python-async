...
class OkStatus2(BaseModel):
    ...
    """ # noqa: E501
    ok: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("OK", "ok"), serialization_alias="OK", description="The actual status itself")
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "OK" not in obj and "ok" in obj:
            obj["OK"] = obj["ok"]
        obj.pop("ok", None)
        return obj
