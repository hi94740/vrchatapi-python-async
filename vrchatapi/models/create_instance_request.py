...
class CreateInstanceRequest(BaseModel):
    ...
    can_request_invite: Optional[StrictBool] = Field(default=False, validation_alias=AliasChoices("canRequestInvite", "can_request_invite"), serialization_alias="canRequestInvite", description="Makes a private instance invite+. A friends instance is rejected.")
    ...
    __properties: ClassVar[List[str]] = ["ageGate", "calendarEntryId", "canRequestInvite", "categoryId", "closedAt", "contentSettings", "description", "displayName", "groupAccessType", "hardClose", "instancePersistenceEnabled", "inviteOnly", "ownerId", "playerPersistenceEnabled", "queueEnabled", "region", "roleIds", "type", "vibeIds", "worldId"]
