...
class APIConfigConstantsINSTANCE(BaseModel):
    """
    ...
    """ # noqa: E501
    population_brackets: Optional[APIConfigConstantsINSTANCEPOPULATIONBRACKETS] = Field(default=None, validation_alias=AliasChoices("POPULATION_BRACKETS", "population_brackets"), serialization_alias="POPULATION_BRACKETS")
    ...
    __properties: ClassVar[List[str]] = ["POPULATION_BRACKETS"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "POPULATION_BRACKETS" not in obj and "population_brackets" in obj:
            obj["POPULATION_BRACKETS"] = obj["population_brackets"]
        obj.pop("population_brackets", None)
        return obj
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of APIConfigConstantsINSTANCE from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        """Return all declared model fields using public or wire names."""
        return {
            ("POPULATION_BRACKETS" if serialize else "population_brackets"): _to_legacy_value(getattr(self, "population_brackets", None), serialize),
        }
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of population_brackets
        if self.population_brackets:
            _dict['POPULATION_BRACKETS'] = _to_openapi_value(self.population_brackets)
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of APIConfigConstantsINSTANCE from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "POPULATION_BRACKETS": APIConfigConstantsINSTANCEPOPULATIONBRACKETS.from_dict(obj["POPULATION_BRACKETS"]) if obj.get("POPULATION_BRACKETS") is not None else None
        })
        return _obj
