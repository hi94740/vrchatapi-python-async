...
class NotificationDetailRequestInviteResponse(BaseModel):
    """
    ...
    """ # noqa: E501
    in_response_to: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("inResponseTo", "in_response_to"), serialization_alias="inResponseTo", json_schema_extra={"examples": ["not_00000000-0000-0000-0000-000000000000"]})
    request_message: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("requestMessage", "request_message"), serialization_alias="requestMessage", description="Used when using InviteMessage Slot.")
    ...
    __properties: ClassVar[List[str]] = ["inResponseTo", "requestMessage"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "inResponseTo" not in obj and "in_response_to" in obj:
            obj["inResponseTo"] = obj["in_response_to"]
        obj.pop("in_response_to", None)
        if "requestMessage" not in obj and "request_message" in obj:
            obj["requestMessage"] = obj["request_message"]
        obj.pop("request_message", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("inResponseTo" if serialize else "in_response_to"): _to_legacy_value(getattr(self, "in_response_to", None), serialize),
            ("requestMessage" if serialize else "request_message"): _to_legacy_value(getattr(self, "request_message", None), serialize),
        }
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inResponseTo": obj.get("inResponseTo"),
