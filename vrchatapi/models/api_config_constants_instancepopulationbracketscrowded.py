...
class APIConfigConstantsINSTANCEPOPULATIONBRACKETSCROWDED(BaseModel):
    """
    ...
    """ # noqa: E501
    max: Optional[StrictInt] = Field(default=None, description="Maximum population for a crowded instance")
    min: Optional[StrictInt] = Field(default=None, description="Minimum population for a crowded instance")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of APIConfigConstantsINSTANCEPOPULATIONBRACKETSCROWDED from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of APIConfigConstantsINSTANCEPOPULATIONBRACKETSCROWDED from a dict"""
        if obj is None:
            return None
