...
class GroupRoleTemplateValuesRoles(BaseModel):
    """
    ...
    base_permissions: Optional[List[GroupPermissions]] = Field(default=None, validation_alias=AliasChoices("basePermissions", "base_permissions"), serialization_alias="basePermissions")
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "basePermissions", "isAddedOnJoin"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "basePermissions" not in obj and "base_permissions" in obj:
            obj["basePermissions"] = obj["base_permissions"]
        obj.pop("base_permissions", None)
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("basePermissions" if serialize else "base_permissions"): _to_legacy_value(getattr(self, "base_permissions", None), serialize),
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "basePermissions": obj.get("basePermissions"),
