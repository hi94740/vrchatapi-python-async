...
class CreateGroupInviteRequest(BaseModel):
    ...
    """ # noqa: E501
    confirm_override_block: Optional[StrictBool] = Field(default=True, validation_alias=AliasChoices("confirmOverrideBlock", "confirm_override_block"), serialization_alias="confirmOverrideBlock")
    ...
    __properties: ClassVar[List[str]] = ["confirmOverrideBlock", "userId"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "confirmOverrideBlock" not in obj and "confirm_override_block" in obj:
            obj["confirmOverrideBlock"] = obj["confirm_override_block"]
        obj.pop("confirm_override_block", None)
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("confirmOverrideBlock" if serialize else "confirm_override_block"): _to_legacy_value(getattr(self, "confirm_override_block", None), serialize),
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "confirmOverrideBlock": obj.get("confirmOverrideBlock") if obj.get("confirmOverrideBlock") is not None else True,
