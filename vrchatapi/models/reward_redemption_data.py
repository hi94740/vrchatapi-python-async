...
class RewardRedemptionData(BaseModel):
    ...
    """ # noqa: E501
    badge: Optional[RewardBadge] = None
    item: Optional[InventoryTemplate] = None
    ...
    __properties: ClassVar[List[str]] = ["badge", "item"]
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("badge" if serialize else "badge"): _to_legacy_value(getattr(self, "badge", None), serialize),
            ("item" if serialize else "item"): _to_legacy_value(getattr(self, "item", None), serialize),
        }
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.badge:
            _dict['badge'] = _to_openapi_value(self.badge)
        # override the default output from pydantic by calling `to_dict()` of item
        if self.item:
            _dict['item'] = _to_openapi_value(self.item)
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "badge": RewardBadge.from_dict(obj["badge"]) if obj.get("badge") is not None else None,
            "item": InventoryTemplate.from_dict(obj["item"]) if obj.get("item") is not None else None
        })
        return _obj
