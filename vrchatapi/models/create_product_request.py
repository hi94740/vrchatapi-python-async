...
class CreateProductRequest(BaseModel):
    ...
    use_for_subscriber_list: Optional[StrictBool] = Field(default=None, validation_alias=AliasChoices("useForSubscriberList", "use_for_subscriber_list"), serialization_alias="useForSubscriberList")
    ...
    __properties: ClassVar[List[str]] = ["description", "displayName", "imageId", "productType", "tags", "useForSubscriberList"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tags": obj.get("tags"),
            "useForSubscriberList": obj.get("useForSubscriberList")
        })
        return _obj
