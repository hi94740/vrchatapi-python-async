...
class Balance(BaseModel):
    ...
    no_transactions: Optional[StrictBool] = Field(default=None, validation_alias=AliasChoices("noTransactions", "no_transactions"), serialization_alias="noTransactions")
    tilia_response: Optional[StrictBool] = Field(default=None, validation_alias=AliasChoices("tiliaResponse", "tilia_response"), serialization_alias="tiliaResponse")
    ...
    __properties: ClassVar[List[str]] = ["balance", "noTransactions", "tiliaResponse"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "noTransactions" not in obj and "no_transactions" in obj:
            obj["noTransactions"] = obj["no_transactions"]
        obj.pop("no_transactions", None)
        if "tiliaResponse" not in obj and "tilia_response" in obj:
            obj["tiliaResponse"] = obj["tilia_response"]
        obj.pop("tilia_response", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("noTransactions" if serialize else "no_transactions"): _to_legacy_value(getattr(self, "no_transactions", None), serialize),
            ("tiliaResponse" if serialize else "tilia_response"): _to_legacy_value(getattr(self, "tilia_response", None), serialize),
        }
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "noTransactions": obj.get("noTransactions"),
            "tiliaResponse": obj.get("tiliaResponse")
        })
        return _obj
