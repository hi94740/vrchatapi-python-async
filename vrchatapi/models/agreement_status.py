...
class AgreementStatus(BaseModel):
    ...
    """ # noqa: E501
    agreed: Optional[StrictBool] = Field(default=None, description="Whether the user has agreed for this content.", json_schema_extra={"examples": [False]})
    ...
    __properties: ClassVar[List[str]] = ["agreed", "agreementCode", "contentId", "userId", "version"]
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("agreed" if serialize else "agreed"): _to_legacy_value(getattr(self, "agreed", None), serialize),
