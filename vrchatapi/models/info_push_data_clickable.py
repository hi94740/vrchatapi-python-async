...
class InfoPushDataClickable(BaseModel):
    ...
    def command_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['CannedWorldSearch', 'OpenSafetyMenu', 'OpenURL', 'OpenVRCPlusMenu']):
            raise ValueError("must be one of enum values ('CannedWorldSearch', 'OpenSafetyMenu', 'OpenURL', 'OpenVRCPlusMenu')")
        return value
