...
class APIConfigOfflineAnalysis(BaseModel):
    """
    ...
    """ # noqa: E501
    android: Optional[StrictBool] = Field(default=True, description="Whether to allow offline analysis")
    standalonewindows: Optional[StrictBool] = Field(default=True, description="Whether to allow offline analysis")
    ...
    __properties: ClassVar[List[str]] = ["android", "standalonewindows"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "android": obj.get("android") if obj.get("android") is not None else True,
            "standalonewindows": obj.get("standalonewindows") if obj.get("standalonewindows") is not None else True
        })
        return _obj
