...
class PlayerModeration(BaseModel):
    """
    PlayerModeration
    ...
    id: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["pmod_25551a8d-6f5d-430a-88d3-9c0ce08b5244"]})
    source_display_name: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, validation_alias=AliasChoices("sourceDisplayName", "source_display_name"), serialization_alias="sourceDisplayName")
    source_user_id: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("sourceUserId", "source_user_id"), serialization_alias="sourceUserId", description="A users unique ID, usually in the form of `usr_c1644b5b-3ca4-45b4-97c6-a2a0de70d469`. Legacy players can have old IDs in the form of `8JoV9XEdpo`. The ID can never be changed.", json_schema_extra={"examples": ["usr_c1644b5b-3ca4-45b4-97c6-a2a0de70d469"]})
    target_display_name: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, validation_alias=AliasChoices("targetDisplayName", "target_display_name"), serialization_alias="targetDisplayName")
    ...
    type: Optional[PlayerModerationType] = None
    ...
    __properties: ClassVar[List[str]] = ["created", "id", "sourceDisplayName", "sourceUserId", "targetDisplayName", "targetUserId", "type"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "sourceDisplayName" not in obj and "source_display_name" in obj:
            obj["sourceDisplayName"] = obj["source_display_name"]
        obj.pop("source_display_name", None)
        if "sourceUserId" not in obj and "source_user_id" in obj:
            obj["sourceUserId"] = obj["source_user_id"]
        obj.pop("source_user_id", None)
        if "targetDisplayName" not in obj and "target_display_name" in obj:
            obj["targetDisplayName"] = obj["target_display_name"]
        obj.pop("target_display_name", None)
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("sourceDisplayName" if serialize else "source_display_name"): _to_legacy_value(getattr(self, "source_display_name", None), serialize),
            ("sourceUserId" if serialize else "source_user_id"): _to_legacy_value(getattr(self, "source_user_id", None), serialize),
            ("targetDisplayName" if serialize else "target_display_name"): _to_legacy_value(getattr(self, "target_display_name", None), serialize),
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type") if obj.get("type") is not None else PlayerModerationType.UNMUTE
        })
        return _obj
