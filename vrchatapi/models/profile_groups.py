...
class ProfileGroups(BaseModel):
    ...
    list: Optional[List[ProfileGroup]] = None
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("list" if serialize else "list"): _to_legacy_value(getattr(self, "list", None), serialize),
        }
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.list:
            for _item_list in self.list:
                if _item_list:
                    _items.append(_to_openapi_value(_item_list))
            _dict['list'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "list": [ProfileGroup.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
