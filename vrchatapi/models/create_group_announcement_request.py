...
class CreateGroupAnnouncementRequest(BaseModel):
    ...
    send_notification: Optional[StrictBool] = Field(default=False, validation_alias=AliasChoices("sendNotification", "send_notification"), serialization_alias="sendNotification", description="Send notification to group members.", json_schema_extra={"examples": [False]})
    text: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, description="Announcement text", json_schema_extra={"examples": ["Come join us for the event!"]})
    title: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, description="Announcement title", json_schema_extra={"examples": ["Event is starting soon!"]})
    ...
    __properties: ClassVar[List[str]] = ["imageId", "sendNotification", "text", "title"]
