...
class InfoPushDataArticleContent(BaseModel):
    """
    ...
    video_url: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("videoUrl", "video_url"), serialization_alias="videoUrl")
    ...
    __properties: ClassVar[List[str]] = ["id", "imageUrl", "onPressed", "text", "title", "videoUrl"]
    ...
    def __preprocess_input_names(
        ...
        if "videoUrl" not in obj and "video_url" in obj:
            obj["videoUrl"] = obj["video_url"]
        obj.pop("video_url", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("videoUrl" if serialize else "video_url"): _to_legacy_value(getattr(self, "video_url", None), serialize),
        }
