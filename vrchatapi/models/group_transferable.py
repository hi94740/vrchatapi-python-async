...
class GroupTransferable(BaseModel):
    """
    GroupTransferable
    ...
    """ # noqa: E501
    requirements: Optional[GroupTransferableRequirements] = None
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.requirements:
            _dict['requirements'] = _to_openapi_value(self.requirements)
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requirements": GroupTransferableRequirements.from_dict(obj["requirements"]) if obj.get("requirements") is not None else None
        })
        return _obj
