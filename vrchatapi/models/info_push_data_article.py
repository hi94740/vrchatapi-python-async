...
class InfoPushDataArticle(BaseModel):
    ...
    """ # noqa: E501
    content: Optional[InfoPushDataArticleContent] = None
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.content:
            _dict['content'] = _to_openapi_value(self.content)
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "content": InfoPushDataArticleContent.from_dict(obj["content"]) if obj.get("content") is not None else None
        })
        return _obj
