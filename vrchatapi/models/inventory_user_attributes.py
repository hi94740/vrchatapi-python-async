...
class InventoryUserAttributes(BaseModel):
    """
    ...
    """ # noqa: E501
    primary_color: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("primaryColor", "primary_color"), serialization_alias="primaryColor")
    secondary_color: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("secondaryColor", "secondary_color"), serialization_alias="secondaryColor")
    trail_color: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("trailColor", "trail_color"), serialization_alias="trailColor")
    ...
    __properties: ClassVar[List[str]] = ["primaryColor", "secondaryColor", "trailColor"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "primaryColor" not in obj and "primary_color" in obj:
            obj["primaryColor"] = obj["primary_color"]
        obj.pop("primary_color", None)
        if "secondaryColor" not in obj and "secondary_color" in obj:
            obj["secondaryColor"] = obj["secondary_color"]
        obj.pop("secondary_color", None)
        if "trailColor" not in obj and "trail_color" in obj:
            obj["trailColor"] = obj["trail_color"]
        obj.pop("trail_color", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("primaryColor" if serialize else "primary_color"): _to_legacy_value(getattr(self, "primary_color", None), serialize),
            ("secondaryColor" if serialize else "secondary_color"): _to_legacy_value(getattr(self, "secondary_color", None), serialize),
            ("trailColor" if serialize else "trail_color"): _to_legacy_value(getattr(self, "trail_color", None), serialize),
        }
