...
class RespondGroupJoinRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    action: Optional[GroupJoinRequestAction] = None
    block: Optional[StrictBool] = Field(default=None, description="Whether to block the user from requesting again")
    ...
    __properties: ClassVar[List[str]] = ["action", "block"]
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("block" if serialize else "block"): _to_legacy_value(getattr(self, "block", None), serialize),
        }
