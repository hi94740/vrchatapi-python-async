...
class ModerateUserRequest(BaseModel):
    ...
    """ # noqa: E501
    moderated: Optional[StrictStr] = Field(default=None, description="A users unique ID, usually in the form of `usr_c1644b5b-3ca4-45b4-97c6-a2a0de70d469`. Legacy players can have old IDs in the form of `8JoV9XEdpo`. The ID can never be changed.", json_schema_extra={"examples": ["usr_c1644b5b-3ca4-45b4-97c6-a2a0de70d469"]})
    ...
    __properties: ClassVar[List[str]] = ["moderated", "type"]
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("moderated" if serialize else "moderated"): _to_legacy_value(getattr(self, "moderated", None), serialize),
