...
class AddFavoriteRequest(BaseModel):
    ...
    """ # noqa: E501
    favorite_id: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("favoriteId", "favorite_id"), serialization_alias="favoriteId", description="Must be either AvatarID, WorldID or UserID.")
    tags: Optional[List[Annotated[str, Field(min_length=1, strict=True)]]] = Field(default=None, description="Tags indicate which group this favorite belongs to. Adding multiple groups makes it show up in all. Removing it from one in that case removes it from all.")
    ...
    __properties: ClassVar[List[str]] = ["favoriteId", "tags", "type"]
