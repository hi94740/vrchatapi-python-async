...
class APIConfigAnnouncement(BaseModel):
    """
    Public Announcement
    ...
    """ # noqa: E501
    name: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, description="Announcement name")
    text: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, description="Announcement text")
