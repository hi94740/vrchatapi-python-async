...
class JamSubmission(BaseModel):
    ...
    ratings_score: Optional[StrictInt] = Field(default=None, validation_alias=AliasChoices("ratingsScore", "ratings_score"), serialization_alias="ratingsScore")
    ...
    __properties: ClassVar[List[str]] = ["contentId", "created_at", "description", "id", "jamId", "ratingsScore", "submitterId"]
    ...
    def __preprocess_input_names(
        ...
        obj.pop("jam_id", None)
        if "ratingsScore" not in obj and "ratings_score" in obj:
            obj["ratingsScore"] = obj["ratings_score"]
        obj.pop("ratings_score", None)
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("ratingsScore" if serialize else "ratings_score"): _to_legacy_value(getattr(self, "ratings_score", None), serialize),
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "jamId": obj.get("jamId"),
            "ratingsScore": obj.get("ratingsScore"),
