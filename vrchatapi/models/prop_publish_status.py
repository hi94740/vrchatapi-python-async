...
class PropPublishStatus(BaseModel):
    """
    PropPublishStatus
    ...
    """ # noqa: E501
    can_publish: Optional[StrictBool] = Field(default=False, validation_alias=AliasChoices("canPublish", "can_publish"), serialization_alias="canPublish")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "canPublish": obj.get("canPublish") if obj.get("canPublish") is not None else False
        })
        return _obj
