...
class License(BaseModel):
    ...
    """ # noqa: E501
    for_action: Optional[LicenseAction] = Field(default=None, validation_alias=AliasChoices("forAction", "for_action"), serialization_alias="forAction")
    for_id: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, validation_alias=AliasChoices("forId", "for_id"), serialization_alias="forId", description="Either a AvatarID, LicenseGroupID, PermissionID or ProductID. This depends on the `forType` field.")
    for_name: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, validation_alias=AliasChoices("forName", "for_name"), serialization_alias="forName")
    for_type: Optional[LicenseType] = Field(default=None, validation_alias=AliasChoices("forType", "for_type"), serialization_alias="forType")
    ...
    __properties: ClassVar[List[str]] = ["forAction", "forId", "forName", "forType"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "forAction" not in obj and "for_action" in obj:
            obj["forAction"] = obj["for_action"]
        obj.pop("for_action", None)
        if "forId" not in obj and "for_id" in obj:
            obj["forId"] = obj["for_id"]
        obj.pop("for_id", None)
        if "forName" not in obj and "for_name" in obj:
            obj["forName"] = obj["for_name"]
        obj.pop("for_name", None)
        if "forType" not in obj and "for_type" in obj:
            obj["forType"] = obj["for_type"]
        obj.pop("for_type", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("forAction" if serialize else "for_action"): _to_legacy_value(getattr(self, "for_action", None), serialize),
            ("forId" if serialize else "for_id"): _to_legacy_value(getattr(self, "for_id", None), serialize),
            ("forName" if serialize else "for_name"): _to_legacy_value(getattr(self, "for_name", None), serialize),
            ("forType" if serialize else "for_type"): _to_legacy_value(getattr(self, "for_type", None), serialize),
        }
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "forAction": obj.get("forAction") if obj.get("forAction") is not None else LicenseAction.HAVE,
            "forId": obj.get("forId"),
            "forName": obj.get("forName"),
            "forType": obj.get("forType") if obj.get("forType") is not None else LicenseType.PERMISSION
        })
        return _obj
