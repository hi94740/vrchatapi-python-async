...
class EquipInventoryItemRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    equip_slot: Optional[InventoryEquipSlot] = Field(default=None, validation_alias=AliasChoices("equipSlot", "equip_slot"), serialization_alias="equipSlot")
    ...
    __properties: ClassVar[List[str]] = ["equipSlot"]
