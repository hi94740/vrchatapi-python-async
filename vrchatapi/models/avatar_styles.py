...
class AvatarStyles(BaseModel):
    ...
    supplementary: Optional[List[StrictStr]] = None
    ...
    __properties: ClassVar[List[str]] = ["primary", "secondary", "supplementary"]
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("primary" if serialize else "primary"): _to_legacy_value(getattr(self, "primary", None), serialize),
            ("secondary" if serialize else "secondary"): _to_legacy_value(getattr(self, "secondary", None), serialize),
            ("supplementary" if serialize else "supplementary"): _to_legacy_value(getattr(self, "supplementary", None), serialize),
        }
