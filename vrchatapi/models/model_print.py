...
class ModelPrint(BaseModel):
    ...
    files: Optional[PrintFiles] = None
    id: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["prnt_0a0aa0a0-85ea-42eb-b2f7-4840d7f341fa"]})
    ...
    world_name: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("worldName", "world_name"), serialization_alias="worldName")
    ...
    __properties: ClassVar[List[str]] = ["authorId", "authorName", "createdAt", "files", "id", "note", "ownerId", "timestamp", "worldId", "worldName"]
    ...
    def __preprocess_input_names(
        ...
        if "worldName" not in obj and "world_name" in obj:
            obj["worldName"] = obj["world_name"]
        obj.pop("world_name", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("files" if serialize else "files"): _to_legacy_value(getattr(self, "files", None), serialize),
            ...
            ("timestamp" if serialize else "timestamp"): _to_legacy_value(getattr(self, "timestamp", None), serialize),
            ("worldId" if serialize else "world_id"): _to_legacy_value(getattr(self, "world_id", None), serialize),
            ("worldName" if serialize else "world_name"): _to_legacy_value(getattr(self, "world_name", None), serialize),
        }
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.files:
            _dict['files'] = _to_openapi_value(self.files)
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "files": PrintFiles.from_dict(obj["files"]) if obj.get("files") is not None else None,
            "id": obj.get("id"),
            "note": obj.get("note"),
            "ownerId": obj.get("ownerId"),
            "timestamp": obj.get("timestamp"),
            "worldId": obj.get("worldId"),
            "worldName": obj.get("worldName")
        })
        return _obj
