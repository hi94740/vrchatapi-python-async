...
class EconomyAccountLimits(BaseModel):
    """
    ...
    """ # noqa: E501
    buying_token_max_per_day: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, validation_alias=AliasChoices("buyingTokenMaxPerDay", "buying_token_max_per_day"), serialization_alias="buyingTokenMaxPerDay")
    buying_token_remaining_allowed: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, validation_alias=AliasChoices("buyingTokenRemainingAllowed", "buying_token_remaining_allowed"), serialization_alias="buyingTokenRemainingAllowed")
    ...
    __properties: ClassVar[List[str]] = ["buyingTokenMaxPerDay", "buyingTokenRemainingAllowed"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "buyingTokenMaxPerDay" not in obj and "buying_token_max_per_day" in obj:
            obj["buyingTokenMaxPerDay"] = obj["buying_token_max_per_day"]
        obj.pop("buying_token_max_per_day", None)
        if "buyingTokenRemainingAllowed" not in obj and "buying_token_remaining_allowed" in obj:
            obj["buyingTokenRemainingAllowed"] = obj["buying_token_remaining_allowed"]
        obj.pop("buying_token_remaining_allowed", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("buyingTokenMaxPerDay" if serialize else "buying_token_max_per_day"): _to_legacy_value(getattr(self, "buying_token_max_per_day", None), serialize),
            ("buyingTokenRemainingAllowed" if serialize else "buying_token_remaining_allowed"): _to_legacy_value(getattr(self, "buying_token_remaining_allowed", None), serialize),
        }
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "buyingTokenMaxPerDay": obj.get("buyingTokenMaxPerDay"),
            "buyingTokenRemainingAllowed": obj.get("buyingTokenRemainingAllowed")
        })
        return _obj
