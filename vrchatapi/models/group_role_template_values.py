...
class GroupRoleTemplateValues(BaseModel):
    """
    ...
    roles: Optional[GroupRoleTemplateValuesRoles] = None
    ...
    __properties: ClassVar[List[str]] = ["basePermissions", "description", "name", "roles"]
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.roles:
            _dict['roles'] = _to_openapi_value(self.roles)
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "roles": GroupRoleTemplateValuesRoles.from_dict(obj["roles"]) if obj.get("roles") is not None else None
        })
        return _obj
