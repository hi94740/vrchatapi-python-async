...
class GroupRoleTemplateValues(BaseModel):
    ...
    roles: Optional[List[GroupRoleTemplateRole]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "roles": [GroupRoleTemplateRole.from_dict(_item) for _item in obj["roles"]] if obj.get("roles") is not None else None
        })
        return _obj
