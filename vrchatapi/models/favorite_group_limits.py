...
class FavoriteGroupLimits(BaseModel):
    """
    FavoriteGroupLimits
    ...
    """ # noqa: E501
    avatar: Optional[StrictInt] = None
    friend: Optional[StrictInt] = None
    vrc_plus_world: Optional[StrictInt] = Field(default=None, validation_alias=AliasChoices("vrcPlusWorld", "vrc_plus_world"), serialization_alias="vrcPlusWorld")
    world: Optional[StrictInt] = None
    ...
    __properties: ClassVar[List[str]] = ["avatar", "friend", "vrcPlusWorld", "world"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "vrcPlusWorld" not in obj and "vrc_plus_world" in obj:
            obj["vrcPlusWorld"] = obj["vrc_plus_world"]
        obj.pop("vrc_plus_world", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("friend" if serialize else "friend"): _to_legacy_value(getattr(self, "friend", None), serialize),
            ("vrcPlusWorld" if serialize else "vrc_plus_world"): _to_legacy_value(getattr(self, "vrc_plus_world", None), serialize),
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vrcPlusWorld": obj.get("vrcPlusWorld"),
            "world": obj.get("world")
        })
        return _obj
