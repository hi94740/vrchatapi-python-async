...
class CreateGroupRequest(BaseModel):
    ...
    role_template: Optional[GroupRoleTemplate] = Field(default=None, validation_alias=AliasChoices("roleTemplate", "role_template"), serialization_alias="roleTemplate")
    ...
    __properties: ClassVar[List[str]] = ["bannerId", "description", "iconId", "joinState", "name", "privacy", "roleTemplate", "shortCode"]
    ...
    def __preprocess_input_names(
        ...
        if "roleTemplate" not in obj and "role_template" in obj:
            obj["roleTemplate"] = obj["role_template"]
        obj.pop("role_template", None)
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("roleTemplate" if serialize else "role_template"): _to_legacy_value(getattr(self, "role_template", None), serialize),
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "roleTemplate": obj.get("roleTemplate") if obj.get("roleTemplate") is not None else GroupRoleTemplate.DEFAULT,
