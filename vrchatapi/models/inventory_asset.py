...
class InventoryAsset(BaseModel):
    ...
    frame_count: Optional[StrictInt] = Field(default=None, validation_alias=AliasChoices("frameCount", "frame_count"), serialization_alias="frameCount")
    frames_per_second: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, validation_alias=AliasChoices("framesPerSecond", "frames_per_second"), serialization_alias="framesPerSecond")
    loop_count: Optional[StrictInt] = Field(default=None, validation_alias=AliasChoices("loopCount", "loop_count"), serialization_alias="loopCount")
    total_duration_ms: Optional[StrictInt] = Field(default=None, validation_alias=AliasChoices("totalDurationMs", "total_duration_ms"), serialization_alias="totalDurationMs")
    ...
    __properties: ClassVar[List[str]] = ["fileId", "frameCount", "framesPerSecond", "loopCount", "totalDurationMs", "type", "url"]
    ...
    def __preprocess_input_names(
        ...
        if "frameCount" not in obj and "frame_count" in obj:
            obj["frameCount"] = obj["frame_count"]
        obj.pop("frame_count", None)
        if "framesPerSecond" not in obj and "frames_per_second" in obj:
            obj["framesPerSecond"] = obj["frames_per_second"]
        obj.pop("frames_per_second", None)
        if "loopCount" not in obj and "loop_count" in obj:
            obj["loopCount"] = obj["loop_count"]
        obj.pop("loop_count", None)
        if "totalDurationMs" not in obj and "total_duration_ms" in obj:
            obj["totalDurationMs"] = obj["total_duration_ms"]
        obj.pop("total_duration_ms", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("frameCount" if serialize else "frame_count"): _to_legacy_value(getattr(self, "frame_count", None), serialize),
            ("framesPerSecond" if serialize else "frames_per_second"): _to_legacy_value(getattr(self, "frames_per_second", None), serialize),
            ("loopCount" if serialize else "loop_count"): _to_legacy_value(getattr(self, "loop_count", None), serialize),
            ("totalDurationMs" if serialize else "total_duration_ms"): _to_legacy_value(getattr(self, "total_duration_ms", None), serialize),
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "framesPerSecond": obj.get("framesPerSecond"),
