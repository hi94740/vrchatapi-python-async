...
class OAuthRedirectCode(BaseModel):
    """
    ...
    """ # noqa: E501
    code: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, json_schema_extra={"examples": ["redirect_00000000-0000-0000-0000-000000000000"]})
