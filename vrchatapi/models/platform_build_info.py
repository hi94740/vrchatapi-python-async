...
class PlatformBuildInfo(BaseModel):
    ...
    """ # noqa: E501
    min_build_number: Optional[StrictInt] = Field(default=None, validation_alias=AliasChoices("minBuildNumber", "min_build_number"), serialization_alias="minBuildNumber", description="Minimum build number required for the platform")
    redirection_address: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("redirectionAddress", "redirection_address"), serialization_alias="redirectionAddress", description="Redirection URL for updating the app")
    ...
    __properties: ClassVar[List[str]] = ["minBuildNumber", "redirectionAddress"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "minBuildNumber" not in obj and "min_build_number" in obj:
            obj["minBuildNumber"] = obj["min_build_number"]
        obj.pop("min_build_number", None)
        if "redirectionAddress" not in obj and "redirection_address" in obj:
            obj["redirectionAddress"] = obj["redirection_address"]
        obj.pop("redirection_address", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("minBuildNumber" if serialize else "min_build_number"): _to_legacy_value(getattr(self, "min_build_number", None), serialize),
            ("redirectionAddress" if serialize else "redirection_address"): _to_legacy_value(getattr(self, "redirection_address", None), serialize),
        }
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "redirectionAddress": obj.get("redirectionAddress")
        })
        return _obj
