...
class FollowCalendarEventRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    is_following: Optional[StrictBool] = Field(default=None, validation_alias=AliasChoices("isFollowing", "is_following"), serialization_alias="isFollowing", json_schema_extra={"examples": [True]})
    ...
    __properties: ClassVar[List[str]] = ["isFollowing"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "isFollowing" not in obj and "is_following" in obj:
            obj["isFollowing"] = obj["is_following"]
        obj.pop("is_following", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("isFollowing" if serialize else "is_following"): _to_legacy_value(getattr(self, "is_following", None), serialize),
        }
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "isFollowing": obj.get("isFollowing")
        })
        return _obj
