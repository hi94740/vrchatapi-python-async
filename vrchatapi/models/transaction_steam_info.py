...
class TransactionSteamInfo(BaseModel):
    """
    ...
    """ # noqa: E501
    order_id: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, validation_alias=AliasChoices("orderId", "order_id"), serialization_alias="orderId", description="Steam Order ID")
    steam_id: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, validation_alias=AliasChoices("steamId", "steam_id"), serialization_alias="steamId", description="Steam User ID")
    steam_url: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("steamUrl", "steam_url"), serialization_alias="steamUrl", description="Empty")
    trans_id: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, validation_alias=AliasChoices("transId", "trans_id"), serialization_alias="transId", description="Steam Transaction ID, NOT the same as VRChat TransactionID")
    wallet_info: Optional[TransactionSteamWalletInfo] = Field(default=None, validation_alias=AliasChoices("walletInfo", "wallet_info"), serialization_alias="walletInfo")
    ...
    __properties: ClassVar[List[str]] = ["orderId", "steamId", "steamUrl", "transId", "walletInfo"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "orderId" not in obj and "order_id" in obj:
            obj["orderId"] = obj["order_id"]
        obj.pop("order_id", None)
        if "steamId" not in obj and "steam_id" in obj:
            obj["steamId"] = obj["steam_id"]
        obj.pop("steam_id", None)
        if "steamUrl" not in obj and "steam_url" in obj:
            obj["steamUrl"] = obj["steam_url"]
        obj.pop("steam_url", None)
        if "transId" not in obj and "trans_id" in obj:
            obj["transId"] = obj["trans_id"]
        obj.pop("trans_id", None)
        if "walletInfo" not in obj and "wallet_info" in obj:
            obj["walletInfo"] = obj["wallet_info"]
        obj.pop("wallet_info", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("orderId" if serialize else "order_id"): _to_legacy_value(getattr(self, "order_id", None), serialize),
            ("steamId" if serialize else "steam_id"): _to_legacy_value(getattr(self, "steam_id", None), serialize),
            ("steamUrl" if serialize else "steam_url"): _to_legacy_value(getattr(self, "steam_url", None), serialize),
            ("transId" if serialize else "trans_id"): _to_legacy_value(getattr(self, "trans_id", None), serialize),
            ("walletInfo" if serialize else "wallet_info"): _to_legacy_value(getattr(self, "wallet_info", None), serialize),
        }
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.wallet_info:
            _dict['walletInfo'] = _to_openapi_value(self.wallet_info)
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "steamUrl": obj.get("steamUrl"),
            "transId": obj.get("transId"),
            "walletInfo": TransactionSteamWalletInfo.from_dict(obj["walletInfo"]) if obj.get("walletInfo") is not None else None
        })
        return _obj
