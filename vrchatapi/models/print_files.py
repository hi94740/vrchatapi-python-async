...
class PrintFiles(BaseModel):
    ...
    image: Optional[StrictStr] = Field(default=None, description="Link to file, e.g. https://api.vrchat.cloud/api/1/file/file_66fe782d-f2bd-4462-9761-1d766d7b2b26/1/file")
    ...
    __properties: ClassVar[List[str]] = ["fileId", "image"]
