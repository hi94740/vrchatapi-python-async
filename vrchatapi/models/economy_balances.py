...
class EconomyBalances(BaseModel):
    """
    EconomyBalances
    ...
    earnings: Optional[StrictInt] = None
    standard: Optional[StrictInt] = None
    ...
    __properties: ClassVar[List[str]] = ["balance", "earnings", "standard"]
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("earnings" if serialize else "earnings"): _to_legacy_value(getattr(self, "earnings", None), serialize),
            ("standard" if serialize else "standard"): _to_legacy_value(getattr(self, "standard", None), serialize),
        }
