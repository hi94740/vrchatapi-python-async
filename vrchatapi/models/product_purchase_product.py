...
class ProductPurchaseProduct(BaseModel):
    """
    ...
    license_id: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("licenseId", "license_id"), serialization_alias="licenseId")
    ...
    __properties: ClassVar[List[str]] = ["displayName", "id", "imageId", "licenseId", "productType"]
    ...
    def __preprocess_input_names(
        ...
        if "licenseId" not in obj and "license_id" in obj:
            obj["licenseId"] = obj["license_id"]
        obj.pop("license_id", None)
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("licenseId" if serialize else "license_id"): _to_legacy_value(getattr(self, "license_id", None), serialize),
