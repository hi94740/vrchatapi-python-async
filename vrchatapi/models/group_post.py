...
class GroupPost(BaseModel):
    ...
    editor_id: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("editorId", "editor_id"), serialization_alias="editorId", description="A users unique ID, usually in the form of `usr_c1644b5b-3ca4-45b4-97c6-a2a0de70d469`. Legacy players can have old IDs in the form of `8JoV9XEdpo`. The ID can never be changed.", json_schema_extra={"examples": ["usr_c1644b5b-3ca4-45b4-97c6-a2a0de70d469"]})
    ...
    id: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["not_00000000-0000-0000-0000-000000000000"]})
    ...
    role_id: Optional[List[StrictStr]] = Field(default=None, validation_alias=AliasChoices("roleId", "role_id"), serialization_alias="roleId", description=" ")
    ...
    visibility: Optional[GroupPostVisibility] = None
    ...
    __properties: ClassVar[List[str]] = ["authorId", "createdAt", "editorId", "groupId", "id", "imageId", "imageUrl", "roleId", "text", "title", "updatedAt", "visibility"]
    ...
    def __preprocess_input_names(
        ...
        if "editorId" not in obj and "editor_id" in obj:
            obj["editorId"] = obj["editor_id"]
        obj.pop("editor_id", None)
        ...
        if "roleId" not in obj and "role_id" in obj:
            obj["roleId"] = obj["role_id"]
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("editorId" if serialize else "editor_id"): _to_legacy_value(getattr(self, "editor_id", None), serialize),
            ...
            ("roleId" if serialize else "role_id"): _to_legacy_value(getattr(self, "role_id", None), serialize),
            ("text" if serialize else "text"): _to_legacy_value(getattr(self, "text", None), serialize),
