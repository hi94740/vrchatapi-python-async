...
class GroupPost(BaseModel):
    ...
    role_ids: Optional[List[StrictStr]] = Field(default=None, validation_alias=AliasChoices("roleIds", "role_ids"), serialization_alias="roleIds", description=" ")
    ...
    __properties: ClassVar[List[str]] = ["authorId", "createdAt", "editorId", "groupId", "id", "imageId", "imageUrl", "roleIds", "text", "title", "updatedAt", "visibility"]
