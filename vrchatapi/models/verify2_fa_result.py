...
class Verify2FAResult(BaseModel):
    """
    Verify2FAResult
    ...
    __properties: ClassVar[List[str]] = ["enabled", "verified"]
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("enabled" if serialize else "enabled"): _to_legacy_value(getattr(self, "enabled", None), serialize),
            ("verified" if serialize else "verified"): _to_legacy_value(getattr(self, "verified", None), serialize),
        }
