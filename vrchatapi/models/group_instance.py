...
class GroupInstance(BaseModel):
    ...
    member_count: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, validation_alias=AliasChoices("memberCount", "member_count"), serialization_alias="memberCount", json_schema_extra={"examples": [6]})
    ...
    __properties: ClassVar[List[str]] = ["instanceId", "location", "memberCount", "world"]
