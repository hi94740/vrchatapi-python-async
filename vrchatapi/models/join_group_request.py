...
class JoinGroupRequest(BaseModel):
    ...
    """ # noqa: E501
    invite_id: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("inviteId", "invite_id"), serialization_alias="inviteId")
    ...
    __properties: ClassVar[List[str]] = ["inviteId"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "inviteId" not in obj and "invite_id" in obj:
            obj["inviteId"] = obj["invite_id"]
        obj.pop("invite_id", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("inviteId" if serialize else "invite_id"): _to_legacy_value(getattr(self, "invite_id", None), serialize),
        }
