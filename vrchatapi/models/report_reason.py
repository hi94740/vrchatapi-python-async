...
class ReportReason(BaseModel):
    ...
    text: Optional[StrictStr] = Field(default=None, description="The label or name of the report reason")
    tooltip: Optional[StrictStr] = Field(default=None, description="A brief explanation of what this reason entails")
    ...
    __properties: ClassVar[List[str]] = ["policy", "text", "tooltip"]
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("policy" if serialize else "policy"): _to_legacy_value(getattr(self, "policy", None), serialize),
