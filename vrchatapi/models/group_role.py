...
class GroupRole(BaseModel):
    ...
    default_role: Optional[StrictBool] = Field(default=False, validation_alias=AliasChoices("defaultRole", "default_role"), serialization_alias="defaultRole")
    ...
    is_added_on_join: Optional[StrictBool] = Field(default=False, validation_alias=AliasChoices("isAddedOnJoin", "is_added_on_join"), serialization_alias="isAddedOnJoin")
    ...
    __properties: ClassVar[List[str]] = ["createdAt", "defaultRole", "description", "groupId", "id", "isAddedOnJoin", "isManagementRole", "isSelfAssignable", "name", "order", "permissions", "productId", "requiresPurchase", "requiresTwoFactor", "updatedAt"]
    ...
    def __preprocess_input_names(
        ...
        if "defaultRole" not in obj and "default_role" in obj:
            obj["defaultRole"] = obj["default_role"]
        obj.pop("default_role", None)
        if "groupId" not in obj and "group_id" in obj:
            obj["groupId"] = obj["group_id"]
        obj.pop("group_id", None)
        if "isAddedOnJoin" not in obj and "is_added_on_join" in obj:
            obj["isAddedOnJoin"] = obj["is_added_on_join"]
        obj.pop("is_added_on_join", None)
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("defaultRole" if serialize else "default_role"): _to_legacy_value(getattr(self, "default_role", None), serialize),
            ...
            ("isAddedOnJoin" if serialize else "is_added_on_join"): _to_legacy_value(getattr(self, "is_added_on_join", None), serialize),
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "defaultRole": obj.get("defaultRole") if obj.get("defaultRole") is not None else False,
            "description": obj.get("description"),
            "groupId": obj.get("groupId"),
            "id": obj.get("id"),
            "isAddedOnJoin": obj.get("isAddedOnJoin") if obj.get("isAddedOnJoin") is not None else False,
