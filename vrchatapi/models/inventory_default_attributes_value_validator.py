...
class InventoryDefaultAttributesValueValidator(BaseModel):
    """
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if not isinstance(other, InventoryDefaultAttributesValueValidator):
            return False
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InventoryDefaultAttributesValueValidator from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InventoryDefaultAttributesValueValidator from a dict"""
        if obj is None:
            return None
