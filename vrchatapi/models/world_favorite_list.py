...
class WorldFavoriteList(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["count", "id", "name", "thumbnails"]
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("thumbnails" if serialize else "thumbnails"): _to_legacy_value(getattr(self, "thumbnails", None), serialize),
        }
