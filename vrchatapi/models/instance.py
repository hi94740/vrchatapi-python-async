...
class Instance(BaseModel):
    ...
    * `hidden` field is only present if InstanceType is `hidden` aka \"Friends+\", and is instance creator. * `friends` field is only present if InstanceType is `friends` aka \"Friends\", and is instance creator. * `private` field is only present if InstanceType is `private` aka \"Invite\" or \"Invite+\", and is instance creator.
    ...
    category_id: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("categoryId", "category_id"), serialization_alias="categoryId", json_schema_extra={"examples": ["icat_44bc6a70-493f-4f84-8a3b-1f290c864c2a"]})
    ...
    creation_languages: Optional[List[Any]] = Field(default=None, validation_alias=AliasChoices("creationLanguages", "creation_languages"), serialization_alias="creationLanguages")
    ...
    dominant_language: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("dominantLanguage", "dominant_language"), serialization_alias="dominantLanguage")
    ...
    language_ratio: Optional[Dict[str, Any]] = Field(default=None, validation_alias=AliasChoices("languageRatio", "language_ratio"), serialization_alias="languageRatio")
    languages: Optional[List[StrictStr]] = Field(default=None, description="The keys of languageRatio, ordered by their share of the instance.")
    languages_iso639: Optional[List[StrictStr]] = Field(default=None, validation_alias=AliasChoices("languagesIso639", "languages_iso639"), serialization_alias="languagesIso639")
    ...
    minimum_avatar_performance: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("minimumAvatarPerformance", "minimum_avatar_performance"), serialization_alias="minimumAvatarPerformance")
    ...
    user_icons: Optional[List[StrictStr]] = Field(default=None, validation_alias=AliasChoices("userIcons", "user_icons"), serialization_alias="userIcons")
    ...
    vibe_ids: Optional[List[StrictStr]] = Field(default=None, validation_alias=AliasChoices("vibeIds", "vibe_ids"), serialization_alias="vibeIds")
    ...
    def __preprocess_input_names(
        ...
        if "categoryId" not in obj and "category_id" in obj:
            obj["categoryId"] = obj["category_id"]
        obj.pop("category_id", None)
        ...
        if "creationLanguages" not in obj and "creation_languages" in obj:
            obj["creationLanguages"] = obj["creation_languages"]
        obj.pop("creation_languages", None)
        ...
        if "dominantLanguage" not in obj and "dominant_language" in obj:
            obj["dominantLanguage"] = obj["dominant_language"]
        obj.pop("dominant_language", None)
        ...
        if "languageRatio" not in obj and "language_ratio" in obj:
            obj["languageRatio"] = obj["language_ratio"]
        obj.pop("language_ratio", None)
        if "languagesIso639" not in obj and "languages_iso639" in obj:
            obj["languagesIso639"] = obj["languages_iso639"]
        obj.pop("languages_iso639", None)
        if "minimumAvatarPerformance" not in obj and "minimum_avatar_performance" in obj:
            obj["minimumAvatarPerformance"] = obj["minimum_avatar_performance"]
        obj.pop("minimum_avatar_performance", None)
        ...
        if "userIcons" not in obj and "user_icons" in obj:
            obj["userIcons"] = obj["user_icons"]
        obj.pop("user_icons", None)
        if "vibeIds" not in obj and "vibe_ids" in obj:
            obj["vibeIds"] = obj["vibe_ids"]
        obj.pop("vibe_ids", None)
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("categoryId" if serialize else "category_id"): _to_legacy_value(getattr(self, "category_id", None), serialize),
            ...
            ("creationLanguages" if serialize else "creation_languages"): _to_legacy_value(getattr(self, "creation_languages", None), serialize),
            ...
            ("dominantLanguage" if serialize else "dominant_language"): _to_legacy_value(getattr(self, "dominant_language", None), serialize),
            ...
            ("languageRatio" if serialize else "language_ratio"): _to_legacy_value(getattr(self, "language_ratio", None), serialize),
            ("languages" if serialize else "languages"): _to_legacy_value(getattr(self, "languages", None), serialize),
            ("languagesIso639" if serialize else "languages_iso639"): _to_legacy_value(getattr(self, "languages_iso639", None), serialize),
            ("location" if serialize else "location"): _to_legacy_value(getattr(self, "location", None), serialize),
            ("minimumAvatarPerformance" if serialize else "minimum_avatar_performance"): _to_legacy_value(getattr(self, "minimum_avatar_performance", None), serialize),
            ...
            ("userIcons" if serialize else "user_icons"): _to_legacy_value(getattr(self, "user_icons", None), serialize),
            ("users" if serialize else "users"): _to_legacy_value(getattr(self, "users", None), serialize),
            ("vibeIds" if serialize else "vibe_ids"): _to_legacy_value(getattr(self, "vibe_ids", None), serialize),
    ...
    def __openapi_generator_modern_projection(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if minimum_avatar_performance (nullable) is None
        # and model_fields_set contains the field
        if self.minimum_avatar_performance is None and "minimum_avatar_performance" in self.model_fields_set:
            _dict['minimumAvatarPerformance'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "languageRatio": obj.get("languageRatio"),
            "languages": obj.get("languages"),
            "languagesIso639": obj.get("languagesIso639"),
            "location": obj.get("location"),
            "minimumAvatarPerformance": obj.get("minimumAvatarPerformance"),
