...
class UpdateFavoriteGroupRequest(BaseModel):
    """
    ...
    tags: Optional[List[Annotated[str, Field(min_length=1, strict=True)]]] = Field(default=None, description="Tags on FavoriteGroups are believed to do nothing.")
    visibility: Optional[FavoriteGroupVisibility] = FavoriteGroupVisibility.PRIVATE
    ...
    __properties: ClassVar[List[str]] = ["displayName", "tags", "visibility"]
