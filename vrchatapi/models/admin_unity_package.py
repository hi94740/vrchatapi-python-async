...
class AdminUnityPackage(BaseModel):
    """
    ...
    """ # noqa: E501
    asset_url: Optional[StrictStr] = Field(default=None, validation_alias=AliasChoices("assetUrl", "asset_url"), serialization_alias="assetUrl", json_schema_extra={"examples": ["https://assets.vrchat.com/adminfiles/adfl_fba880f3-7d8c-4429-87e6-0e2d50000076ie_chad_rat_standalonewindows"]})
    ...
    unity_version: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, validation_alias=AliasChoices("unityVersion", "unity_version"), serialization_alias="unityVersion", json_schema_extra={"examples": ["2022.3.22f1-DWR"]})
    ...
    __properties: ClassVar[List[str]] = ["assetUrl", "assetVersion", "platform", "unityVersion", "variant"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "unityVersion": obj.get("unityVersion") if obj.get("unityVersion") is not None else '2022.3.22f1-DWR',
