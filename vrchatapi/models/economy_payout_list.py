...
class EconomyPayoutList(BaseModel):
    """
    EconomyPayoutList
    ...
    """ # noqa: E501
    payouts: Optional[List[EconomyPayout]] = None
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("payouts" if serialize else "payouts"): _to_legacy_value(getattr(self, "payouts", None), serialize),
        }
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.payouts:
            for _item_payouts in self.payouts:
                if _item_payouts:
                    _items.append(_to_openapi_value(_item_payouts))
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payouts": [EconomyPayout.from_dict(_item) for _item in obj["payouts"]] if obj.get("payouts") is not None else None
        })
        return _obj
