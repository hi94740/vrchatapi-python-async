...
class TiliaStatus(BaseModel):
    ...
    """ # noqa: E501
    economy_online: Optional[StrictBool] = Field(default=None, validation_alias=AliasChoices("economyOnline", "economy_online"), serialization_alias="economyOnline")
    economy_state: Optional[StrictInt] = Field(default=None, validation_alias=AliasChoices("economyState", "economy_state"), serialization_alias="economyState")
    planned_offline_window_end: Optional[datetime] = Field(default=None, validation_alias=AliasChoices("plannedOfflineWindowEnd", "planned_offline_window_end"), serialization_alias="plannedOfflineWindowEnd")
    planned_offline_window_start: Optional[datetime] = Field(default=None, validation_alias=AliasChoices("plannedOfflineWindowStart", "planned_offline_window_start"), serialization_alias="plannedOfflineWindowStart")
    ...
    __properties: ClassVar[List[str]] = ["economyOnline", "economyState", "plannedOfflineWindowEnd", "plannedOfflineWindowStart"]
    ...
    def __preprocess_input_names(
        ...
        if not isinstance(obj, _Mapping):
            return obj
        obj = dict(obj)
        if "economyOnline" not in obj and "economy_online" in obj:
            obj["economyOnline"] = obj["economy_online"]
        obj.pop("economy_online", None)
        if "economyState" not in obj and "economy_state" in obj:
            obj["economyState"] = obj["economy_state"]
        obj.pop("economy_state", None)
        if "plannedOfflineWindowEnd" not in obj and "planned_offline_window_end" in obj:
            obj["plannedOfflineWindowEnd"] = obj["planned_offline_window_end"]
        obj.pop("planned_offline_window_end", None)
        if "plannedOfflineWindowStart" not in obj and "planned_offline_window_start" in obj:
            obj["plannedOfflineWindowStart"] = obj["planned_offline_window_start"]
        obj.pop("planned_offline_window_start", None)
        return obj
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ("economyOnline" if serialize else "economy_online"): _to_legacy_value(getattr(self, "economy_online", None), serialize),
            ("economyState" if serialize else "economy_state"): _to_legacy_value(getattr(self, "economy_state", None), serialize),
            ("plannedOfflineWindowEnd" if serialize else "planned_offline_window_end"): _to_legacy_value(getattr(self, "planned_offline_window_end", None), serialize),
            ("plannedOfflineWindowStart" if serialize else "planned_offline_window_start"): _to_legacy_value(getattr(self, "planned_offline_window_start", None), serialize),
        }
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "economyOnline": obj.get("economyOnline"),
            "economyState": obj.get("economyState"),
            "plannedOfflineWindowEnd": obj.get("plannedOfflineWindowEnd"),
            "plannedOfflineWindowStart": obj.get("plannedOfflineWindowStart")
        })
        return _obj
