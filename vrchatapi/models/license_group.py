...
class LicenseGroup(BaseModel):
    ...
    id: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["lgrp_608513da-b213-4e15-80af-bd88c27f0979"]})
    ...
    __properties: ClassVar[List[str]] = ["description", "id", "licenses", "name"]
    ...
    def to_dict(self, serialize: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            ("licenses" if serialize else "licenses"): _to_legacy_value(getattr(self, "licenses", None), serialize),
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.licenses:
            for _item_licenses in self.licenses:
                if _item_licenses:
                    _items.append(_to_openapi_value(_item_licenses))
