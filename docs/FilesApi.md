...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Create File
        api_response = await api_instance.create_file(create_file_request=create_file_request)
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Create File Version
        api_response = await api_instance.create_file_version(file_id, create_file_version_request=create_file_version_request)
        print("The response of FilesApi->create_file_version:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete File
        api_response = await api_instance.delete_file(file_id)
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete File Version
        api_response = await api_instance.delete_file_version(file_id, version_id)
        print("The response of FilesApi->delete_file_version:\n")
        pprint(api_response)
    except Exception as e:
...
> bytes download_file_version(file_id, version_id)
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Download File Version
        api_response = await api_instance.download_file_version(file_id, version_id)
        print("The response of FilesApi->download_file_version:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Finish FileData Upload
        api_response = await api_instance.finish_file_data_upload(file_id, version_id, file_type, finish_file_data_upload_request=finish_file_data_upload_request)
        print("The response of FilesApi->finish_file_data_upload:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get AdminAssetBundle
        api_response = await api_instance.get_admin_asset_bundle(admin_asset_bundle_id)
        print("The response of FilesApi->get_admin_asset_bundle:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = vrchatapi.FilesApi(api_client)
    agreement_code = 'content.copyright.owned' # AgreementCode | The type of agreement (currently content.copyright.owned) (default to 'content.copyright.owned')
    ...
    try:
        # Get Content Agreement Status
        api_response = await api_instance.get_content_agreement_status(agreement_code, content_id, version)
        print("The response of FilesApi->get_content_agreement_status:\n")
        pprint(api_response)
    except Exception as e:
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **agreement_code** | [**AgreementCode**](.md)| The type of agreement (currently content.copyright.owned) | [default to &#39;content.copyright.owned&#39;]
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Show File
        api_response = await api_instance.get_file(file_id)
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get File Version Analysis
        api_response = await api_instance.get_file_analysis(file_id, version_id)
        print("The response of FilesApi->get_file_analysis:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get File Version Analysis Security
        api_response = await api_instance.get_file_analysis_security(file_id, version_id)
        print("The response of FilesApi->get_file_analysis_security:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get File Version Analysis Standard
        api_response = await api_instance.get_file_analysis_standard(file_id, version_id)
        print("The response of FilesApi->get_file_analysis_standard:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Check FileData Upload Status
        api_response = await api_instance.get_file_data_upload_status(file_id, version_id, file_type)
        print("The response of FilesApi->get_file_data_upload_status:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # List Files
        api_response = await api_instance.get_files(tag=tag, user_id=user_id, n=n, offset=offset)
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Set Group Gallery File Order
        api_response = await api_instance.set_group_gallery_file_order(group_gallery_file_order_request=group_gallery_file_order_request)
        print("The response of FilesApi->set_group_gallery_file_order:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Start FileData Upload
        api_response = await api_instance.start_file_data_upload(file_id, version_id, file_type, part_number=part_number)
        print("The response of FilesApi->start_file_data_upload:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Submit Content Agreement
        api_response = await api_instance.submit_content_agreement(agreement_request=agreement_request)
        print("The response of FilesApi->submit_content_agreement:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Update Asset Review Notes
        await api_instance.update_asset_review_notes(asset_review_id, update_asset_review_notes_request=update_asset_review_notes_request)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = vrchatapi.FilesApi(api_client)
    file = None # bytes | The binary blob of the png file.

    try:
        # Upload gallery image
        api_response = await api_instance.upload_gallery_image(file)
        print("The response of FilesApi->upload_gallery_image:\n")
        pprint(api_response)
    except Exception as e:
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **file** | **bytes**| The binary blob of the png file. | 
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Upload icon
        api_response = await api_instance.upload_icon(file)
        print("The response of FilesApi->upload_icon:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    api_instance = vrchatapi.FilesApi(api_client)
    file = None # bytes | The binary blob of the png file.
    tag = 'gallery' # ImagePurpose |  (default to 'gallery')
    ...
    loop_style = 'linear' # ImageLoopStyle |  (optional) (default to 'linear')
    mask_tag = 'square' # ImageMask |  (optional) (default to 'square')

    try:
        # Upload gallery image, icon, emoji or sticker
        api_response = await api_instance.upload_image(file, tag, animation_style=animation_style, frames=frames, frames_over_time=frames_over_time, loop_style=loop_style, mask_tag=mask_tag)
        print("The response of FilesApi->upload_image:\n")
        pprint(api_response)
    except Exception as e:
 ...
 **loop_style** | [**ImageLoopStyle**](ImageLoopStyle.md)|  | [optional] [default to &#39;linear&#39;]
 **mask_tag** | [**ImageMask**](ImageMask.md)|  | [optional] [default to &#39;square&#39;]
