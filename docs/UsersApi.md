...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Age Verification Status
        api_response = await api_instance.get_age_verification_status()
        print("The response of UsersApi->get_age_verification_status:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Public Profile
        api_response = await api_instance.get_public_profile(user_id, as_self=as_self, with_groups_and_worlds=with_groups_and_worlds)
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get User Client Config
        api_response = await api_instance.get_user_client_config(user_id)
        print("The response of UsersApi->get_user_client_config:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Update Profile
        api_response = await api_instance.update_profile(user_id, update_profile_request=update_profile_request)
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Update User Client Config
        api_response = await api_instance.update_user_client_config(user_id, update_user_client_config_request=update_user_client_config_request)
        print("The response of UsersApi->update_user_client_config:\n")
        pprint(api_response)
    except Exception as e:
