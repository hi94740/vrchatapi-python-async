...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Add World Tags
        api_response = await api_instance.add_world_tags(world_id, change_world_tags_request)
        print("The response of WorldsApi->add_world_tags:\n")
        pprint(api_response)
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Create World
        api_response = await api_instance.create_world(create_world_request=create_world_request)
        print("The response of WorldsApi->create_world:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete World
        await api_instance.delete_world(world_id)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete World Platform
        await api_instance.delete_world_platform(world_id, published_platform)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # List Active Worlds
        api_response = await api_instance.get_active_worlds(featured=featured, sort=sort, n=n, order=order, offset=offset, search=search, tag=tag, notag=notag, release_status=release_status, max_unity_version=max_unity_version, min_unity_version=min_unity_version, platform=platform, noplatform=noplatform)
        print("The response of WorldsApi->get_active_worlds:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # List Favorited Worlds
        api_response = await api_instance.get_favorited_worlds(featured=featured, sort=sort, n=n, order=order, offset=offset, search=search, tag=tag, notag=notag, release_status=release_status, max_unity_version=max_unity_version, min_unity_version=min_unity_version, platform=platform, user_id=user_id)
        print("The response of WorldsApi->get_favorited_worlds:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # List Recent Worlds
        api_response = await api_instance.get_recent_worlds(featured=featured, sort=sort, n=n, order=order, offset=offset, search=search, tag=tag, notag=notag, release_status=release_status, max_unity_version=max_unity_version, min_unity_version=min_unity_version, platform=platform, user_id=user_id)
        print("The response of WorldsApi->get_recent_worlds:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get World by ID
        api_response = await api_instance.get_world(world_id)
        print("The response of WorldsApi->get_world:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get World Instance
        api_response = await api_instance.get_world_instance(world_id, instance_id)
        print("The response of WorldsApi->get_world_instance:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get World Metadata
        api_response = await api_instance.get_world_metadata(world_id)
        print("The response of WorldsApi->get_world_metadata:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get World Publish Status
        api_response = await api_instance.get_world_publish_status(world_id)
        print("The response of WorldsApi->get_world_publish_status:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Publish World
        await api_instance.publish_world(world_id)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Remove World Tags
        api_response = await api_instance.remove_world_tags(world_id, change_world_tags_request)
        print("The response of WorldsApi->remove_world_tags:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Search All Worlds
        api_response = await api_instance.search_worlds(featured=featured, sort=sort, user=user, user_id=user_id, n=n, order=order, offset=offset, search=search, tag=tag, notag=notag, release_status=release_status, max_unity_version=max_unity_version, min_unity_version=min_unity_version, platform=platform, noplatform=noplatform, fuzzy=fuzzy, avatar_specific=avatar_specific)
        print("The response of WorldsApi->search_worlds:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Unpublish World
        await api_instance.unpublish_world(world_id)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Update World
        api_response = await api_instance.update_world(world_id, update_world_request=update_world_request)
        print("The response of WorldsApi->update_world:\n")
        pprint(api_response)
    except Exception as e:
