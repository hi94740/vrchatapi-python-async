...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # List Cosmetics
        api_response = await api_instance.get_cosmetic_index(item_type)
        print("The response of InventoryApi->get_cosmetic_index:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Inventory
        api_response = await api_instance.get_inventory(n=n, offset=offset, holder_id=holder_id, equip_slot=equip_slot, order=order, tags=tags, types=types, flags=flags, not_types=not_types, not_flags=not_flags, archived=archived, seen=seen, is_nav_bar=is_nav_bar)
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # List User Cosmetics
        api_response = await api_instance.get_user_cosmetics(user_id)
        print("The response of InventoryApi->get_user_cosmetics:\n")
        pprint(api_response)
    except Exception as e:
