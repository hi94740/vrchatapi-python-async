...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Close Instance
        api_response = await api_instance.close_instance(world_id, instance_id, hard_close=hard_close, closed_at=closed_at)
        print("The response of InstancesApi->close_instance:\n")
        pprint(api_response)
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Create Instance
        api_response = await api_instance.create_instance(create_instance_request)
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Instance
        api_response = await api_instance.get_instance(world_id, instance_id)
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Instance By Short Name
        api_response = await api_instance.get_instance_by_short_name(short_name)
        print("The response of InstancesApi->get_instance_by_short_name:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # List Instance Categories
        api_response = await api_instance.get_instance_categories()
        print("The response of InstancesApi->get_instance_categories:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # List Instance Vibes
        api_response = await api_instance.get_instance_vibes()
        print("The response of InstancesApi->get_instance_vibes:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # List Recent Locations
        api_response = await api_instance.get_recent_locations(n=n, offset=offset)
        print("The response of InstancesApi->get_recent_locations:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Instance Short Name
        api_response = await api_instance.get_short_name(world_id, instance_id)
        print("The response of InstancesApi->get_short_name:\n")
        pprint(api_response)
    except Exception as e:
