...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Send Boop
        api_response = await api_instance.boop(user_id, boop_request)
        print("The response of FriendsApi->boop:\n")
        pprint(api_response)
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete Friend Request
        api_response = await api_instance.delete_friend_request(user_id)
        print("The response of FriendsApi->delete_friend_request:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Send Friend Request
        api_response = await api_instance.friend(user_id)
        print("The response of FriendsApi->friend:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Check Friend Status
        api_response = await api_instance.get_friend_status(user_id)
        print("The response of FriendsApi->get_friend_status:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # List Friends
        api_response = await api_instance.get_friends(offset=offset, n=n, offline=offline)
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Unfriend
        api_response = await api_instance.unfriend(user_id)
        print("The response of FriendsApi->unfriend:\n")
        pprint(api_response)
    except Exception as e:
