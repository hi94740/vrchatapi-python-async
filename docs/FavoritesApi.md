...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Add Favorite
        api_response = await api_instance.add_favorite(add_favorite_request=add_favorite_request)
        print("The response of FavoritesApi->add_favorite:\n")
        pprint(api_response)
...
async with vrchatapi.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = vrchatapi.FavoritesApi(api_client)
    favorite_group_type = 'friend' # FavoriteType | The type of group to fetch, must be a valid FavoriteType. (default to 'friend')
    ...
    try:
        # Clear Favorite Group
        api_response = await api_instance.clear_favorite_group(favorite_group_type, favorite_group_name, user_id)
        print("The response of FavoritesApi->clear_favorite_group:\n")
        pprint(api_response)
    except Exception as e:
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **favorite_group_type** | [**FavoriteType**](.md)| The type of group to fetch, must be a valid FavoriteType. | [default to &#39;friend&#39;]
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Show Favorite Group
        api_response = await api_instance.get_favorite_group(favorite_group_type, favorite_group_name, user_id)
        print("The response of FavoritesApi->get_favorite_group:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # List Favorite Group Contents
        api_response = await api_instance.get_favorite_group_contents(favorite_group_type, favorite_group_name, owner_id=owner_id)
        print("The response of FavoritesApi->get_favorite_group_contents:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    type = 'friend' # FavoriteType | Filter to a single favorite group type. (optional) (default to 'friend')
    ...
    try:
        # List Favorite Groups
        api_response = await api_instance.get_favorite_groups(n=n, offset=offset, type=type, user_id=user_id, owner_id=owner_id)
        print("The response of FavoritesApi->get_favorite_groups:\n")
        pprint(api_response)
    except Exception as e:
 ...
 **type** | [**FavoriteType**](.md)| Filter to a single favorite group type. | [optional] [default to &#39;friend&#39;]
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # List Favorite Groups By Type
        api_response = await api_instance.get_favorite_groups_by_type(favorite_group_type, owner_id=owner_id)
        print("The response of FavoritesApi->get_favorite_groups_by_type:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Favorite Limits
        api_response = await api_instance.get_favorite_limits()
        print("The response of FavoritesApi->get_favorite_limits:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # List Favorites
        api_response = await api_instance.get_favorites(n=n, offset=offset, type=type, tag=tag)
        print("The response of FavoritesApi->get_favorites:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Remove Favorite
        api_response = await api_instance.remove_favorite(favorite_id)
        print("The response of FavoritesApi->remove_favorite:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Update Favorite Group
        await api_instance.update_favorite_group(favorite_group_type, favorite_group_name, user_id, update_favorite_group_request=update_favorite_group_request)
    except Exception as e:
