...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Assigned Permissions
        api_response = await api_instance.get_assigned_permissions()
        print("The response of MiscellaneousApi->get_assigned_permissions:\n")
        pprint(api_response)
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Beta Program
        api_response = await api_instance.get_beta(beta_name)
        print("The response of MiscellaneousApi->get_beta:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Beta Registration
        await api_instance.get_beta_registration(beta_name)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MiscellaneousApi->get_config:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Download CSS
        api_response = await api_instance.get_css(variant=variant, branch=branch)
        print("The response of MiscellaneousApi->get_css:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Current Online Users
        api_response = await api_instance.get_current_online_users()
        print("The response of MiscellaneousApi->get_current_online_users:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # List Frontend Branches
        api_response = await api_instance.get_frontend_branches()
        print("The response of MiscellaneousApi->get_frontend_branches:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MiscellaneousApi->get_health:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Show Information Notices
        api_response = await api_instance.get_info_push(require=require, include=include)
        print("The response of MiscellaneousApi->get_info_push:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Download JavaScript
        api_response = await api_instance.get_java_script(variant=variant, branch=branch)
        print("The response of MiscellaneousApi->get_java_script:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Permission
        api_response = await api_instance.get_permission(permission_id)
        print("The response of MiscellaneousApi->get_permission:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Current System Time
        api_response = await api_instance.get_system_time()
        print("The response of MiscellaneousApi->get_system_time:\n")
        pprint(api_response)
    except Exception as e:
