...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Create a calendar event
        api_response = await api_instance.create_group_calendar_event(group_id, create_calendar_event_request)
        print("The response of CalendarApi->create_group_calendar_event:\n")
        pprint(api_response)
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete a calendar event
        api_response = await api_instance.delete_group_calendar_event(group_id, calendar_id)
        print("The response of CalendarApi->delete_group_calendar_event:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = vrchatapi.CalendarApi(api_client)
    scope = 'upcoming' # CalendarEventDiscoveryScope | Scope for calendar event discovery. (optional) (default to 'upcoming')
    ...
    featured_results = 'include' # CalendarEventDiscoveryInclusion | Filter for calendar event discovery. (optional) (default to 'include')
    non_featured_results = 'include' # CalendarEventDiscoveryInclusion | Filter for calendar event discovery. (optional) (default to 'include')
    personalized_results = 'include' # CalendarEventDiscoveryInclusion | Filter for calendar event discovery. (optional) (default to 'include')
    ...
    try:
        # Discover calendar events
        api_response = await api_instance.discover_calendar_events(scope=scope, categories=categories, tags=tags, featured_results=featured_results, non_featured_results=non_featured_results, personalized_results=personalized_results, minimum_interest_count=minimum_interest_count, minimum_remaining_minutes=minimum_remaining_minutes, upcoming_offset_minutes=upcoming_offset_minutes, n=n, next_cursor=next_cursor)
        print("The response of CalendarApi->discover_calendar_events:\n")
        pprint(api_response)
    except Exception as e:
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **scope** | [**CalendarEventDiscoveryScope**](.md)| Scope for calendar event discovery. | [optional] [default to &#39;upcoming&#39;]
 **categories** | **str**| Filter for calendar event discovery. | [optional] 
 **tags** | **str**| Filter for calendar event discovery. | [optional] 
 **featured_results** | [**CalendarEventDiscoveryInclusion**](.md)| Filter for calendar event discovery. | [optional] [default to &#39;include&#39;]
 **non_featured_results** | [**CalendarEventDiscoveryInclusion**](.md)| Filter for calendar event discovery. | [optional] [default to &#39;include&#39;]
 **personalized_results** | [**CalendarEventDiscoveryInclusion**](.md)| Filter for calendar event discovery. | [optional] [default to &#39;include&#39;]
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Follow a calendar event
        api_response = await api_instance.follow_group_calendar_event(group_id, calendar_id, follow_calendar_event_request)
        print("The response of CalendarApi->follow_group_calendar_event:\n")
        pprint(api_response)
    except Exception as e:
...
# **get_calendar_events**
> PaginatedCalendarEventList get_calendar_events(var_date=var_date, n=n, offset=offset)
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # List calendar events
        api_response = await api_instance.get_calendar_events(var_date=var_date, n=n, offset=offset)
        print("The response of CalendarApi->get_calendar_events:\n")
        pprint(api_response)
    except Exception as e:
...
> PaginatedCalendarEventList get_featured_calendar_events(var_date=var_date, n=n, offset=offset)
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # List featured calendar events
        api_response = await api_instance.get_featured_calendar_events(var_date=var_date, n=n, offset=offset)
        print("The response of CalendarApi->get_featured_calendar_events:\n")
        pprint(api_response)
    except Exception as e:
...
> PaginatedCalendarEventList get_followed_calendar_events(var_date=var_date, n=n, offset=offset)
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # List followed calendar events
        api_response = await api_instance.get_followed_calendar_events(var_date=var_date, n=n, offset=offset)
        print("The response of CalendarApi->get_followed_calendar_events:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a calendar event
        api_response = await api_instance.get_group_calendar_event(group_id, calendar_id)
        print("The response of CalendarApi->get_group_calendar_event:\n")
        pprint(api_response)
    except Exception as e:
...
> bytes get_group_calendar_event_ics(group_id, calendar_id)
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Download calendar event as ICS
        api_response = await api_instance.get_group_calendar_event_ics(group_id, calendar_id)
        print("The response of CalendarApi->get_group_calendar_event_ics:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get next calendar event
        api_response = await api_instance.get_group_next_calendar_event(group_id)
        print("The response of CalendarApi->get_group_next_calendar_event:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Search for calendar events
        api_response = await api_instance.search_calendar_events(search_term, utc_offset=utc_offset, n=n, offset=offset, is_internal_variant=is_internal_variant)
        print("The response of CalendarApi->search_calendar_events:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Update a calendar event
        api_response = await api_instance.update_group_calendar_event(group_id, calendar_id, update_calendar_event_request)
        print("The response of CalendarApi->update_group_calendar_event:\n")
        pprint(api_response)
    except Exception as e:
