...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete Print
        await api_instance.delete_print(print_id)
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Edit Print
        api_response = await api_instance.edit_print(print_id, image, note=note)
        print("The response of PrintsApi->edit_print:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Print
        api_response = await api_instance.get_print(print_id)
        print("The response of PrintsApi->get_print:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Own Prints
        api_response = await api_instance.get_user_prints(user_id)
        print("The response of PrintsApi->get_user_prints:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Upload Print
        api_response = await api_instance.upload_print(image, timestamp, note=note, world_id=world_id, world_name=world_name)
        print("The response of PrintsApi->upload_print:\n")
        pprint(api_response)
    except Exception as e:
