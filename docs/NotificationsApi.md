...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Accept Friend Request
        api_response = await api_instance.accept_friend_request(notification_id)
        print("The response of NotificationsApi->accept_friend_request:\n")
        pprint(api_response)
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Acknowledge NotificationV2
        api_response = await api_instance.acknowledge_notification_v2(notification_id)
        print("The response of NotificationsApi->acknowledge_notification_v2:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Clear All Notifications
        api_response = await api_instance.clear_notifications()
        print("The response of NotificationsApi->clear_notifications:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete All NotificationV2s
        api_response = await api_instance.delete_all_notification_v2s()
        print("The response of NotificationsApi->delete_all_notification_v2s:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete Notification
        api_response = await api_instance.delete_notification(notification_id)
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete NotificationV2
        api_response = await api_instance.delete_notification_v2(notification_id)
        print("The response of NotificationsApi->delete_notification_v2:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Show notification
        api_response = await api_instance.get_notification(notification_id)
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get NotificationV2
        api_response = await api_instance.get_notification_v2(notification_id)
        print("The response of NotificationsApi->get_notification_v2:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # List NotificationV2s
        api_response = await api_instance.get_notification_v2s(limit=limit)
        print("The response of NotificationsApi->get_notification_v2s:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # List Notifications
        api_response = await api_instance.get_notifications(type=type, sent=sent, hidden=hidden, after=after, n=n, offset=offset)
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Mark Notification As Read
        api_response = await api_instance.mark_notification_as_read(notification_id)
        print("The response of NotificationsApi->mark_notification_as_read:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Reply NotificationV2
        api_response = await api_instance.reply_notification_v2(notification_id, body)
        print("The response of NotificationsApi->reply_notification_v2:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Respond NotificationV2
        api_response = await api_instance.respond_notification_v2(notification_id, respond_notification_v2_request)
        print("The response of NotificationsApi->respond_notification_v2:\n")
        pprint(api_response)
    except Exception as e:
