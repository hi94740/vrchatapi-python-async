...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Cancel pending enabling of time-based 2FA codes
        api_response = await api_instance.cancel_pending2_fa()
        print("The response of AuthenticationApi->cancel_pending2_fa:\n")
        pprint(api_response)
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Check User Exists
        api_response = await api_instance.check_user_exists(email=email, display_name=display_name, username=username, exclude_user_id=exclude_user_id)
        print("The response of AuthenticationApi->check_user_exists:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Confirm Email
        await api_instance.confirm_email(id, verify_email)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Create Global Avatar Moderation
        api_response = await api_instance.create_global_avatar_moderation(create_avatar_moderation_request)
        print("The response of AuthenticationApi->create_global_avatar_moderation:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete Global Avatar Moderation
        api_response = await api_instance.delete_global_avatar_moderation(target_avatar_id, avatar_moderation_type)
        print("The response of AuthenticationApi->delete_global_avatar_moderation:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete Moderation Report
        api_response = await api_instance.delete_moderation_report(moderation_report_id)
        print("The response of AuthenticationApi->delete_moderation_report:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Disable 2FA
        api_response = await api_instance.disable2_fa()
        print("The response of AuthenticationApi->disable2_fa:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Enable time-based 2FA codes
        api_response = await api_instance.enable2_fa()
        print("The response of AuthenticationApi->enable2_fa:\n")
        pprint(api_response)
    except Exception as e:
...
configuration.api_key['twoFactorAuthCookie'] = os.environ["API_KEY"]
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Global Avatar Moderations
        api_response = await api_instance.get_global_avatar_moderations()
        print("The response of AuthenticationApi->get_global_avatar_moderations:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Moderation Reports
        api_response = await api_instance.get_moderation_reports(offset=offset, n=n, reporting_user_id=reporting_user_id, status=status, type=type)
        print("The response of AuthenticationApi->get_moderation_reports:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get OAuth Redirect Code
        api_response = await api_instance.get_o_auth_redirect_code()
        print("The response of AuthenticationApi->get_o_auth_redirect_code:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get 2FA Recovery codes
        api_response = await api_instance.get_recovery_codes()
        print("The response of AuthenticationApi->get_recovery_codes:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get SSO Token
        api_response = await api_instance.get_sso_token(provider)
        print("The response of AuthenticationApi->get_sso_token:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Register User Account
        api_response = await api_instance.register_user_account(register_user_account_request)
        print("The response of AuthenticationApi->register_user_account:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Resend Email Confirmation
        api_response = await api_instance.resend_email_confirmation()
        print("The response of AuthenticationApi->resend_email_confirmation:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Submit Moderation Report
        api_response = await api_instance.submit_moderation_report(submit_moderation_report_request)
        print("The response of AuthenticationApi->submit_moderation_report:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Verify 2FA code
        api_response = await api_instance.verify2_fa(two_factor_auth_code)
        print("The response of AuthenticationApi->verify2_fa:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Verify 2FA email code
        api_response = await api_instance.verify2_fa_email_code(two_factor_email_code)
        print("The response of AuthenticationApi->verify2_fa_email_code:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Verify Auth Token
        api_response = await api_instance.verify_auth_token()
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Verify Login Place
        await api_instance.verify_login_place(token, user_id=user_id)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Verify Pending 2FA code
        api_response = await api_instance.verify_pending2_fa(two_factor_auth_code)
        print("The response of AuthenticationApi->verify_pending2_fa:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Verify 2FA code with Recovery code
        api_response = await api_instance.verify_recovery_code(two_factor_auth_code)
        print("The response of AuthenticationApi->verify_recovery_code:\n")
        pprint(api_response)
    except Exception as e:
