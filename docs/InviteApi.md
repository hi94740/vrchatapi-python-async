...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    message_type = 'message' # InviteMessageType | The type of message to fetch, must be a valid InviteMessageType. (default to 'message')
    slot = 56 # int | The message slot to fetch of a given message type.

    try:
        # Get Invite Message
        api_response = await api_instance.get_invite_message(user_id, message_type, slot)
        print("The response of InviteApi->get_invite_message:\n")
        pprint(api_response)
 ...
 **message_type** | [**InviteMessageType**](.md)| The type of message to fetch, must be a valid InviteMessageType. | [default to &#39;message&#39;]
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # List Invite Messages
        api_response = await api_instance.get_invite_messages(user_id, message_type)
        print("The response of InviteApi->get_invite_messages:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Invite Myself To Instance
        api_response = await api_instance.invite_myself_to(world_id, instance_id)
        print("The response of InviteApi->invite_myself_to:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Invite User
        api_response = await api_instance.invite_user(user_id, invite_request)
        print("The response of InviteApi->invite_user:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    image = None # bytes | The binary blob of the png file.

    try:
        # Invite User with photo
        api_response = await api_instance.invite_user_with_photo(user_id, data, image)
        print("The response of InviteApi->invite_user_with_photo:\n")
        pprint(api_response)
    except Exception as e:
 ...
 **image** | **bytes**| The binary blob of the png file. | 
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Request Invite
        api_response = await api_instance.request_invite(user_id, request_invite_request=request_invite_request)
        print("The response of InviteApi->request_invite:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Request Invite with photo
        api_response = await api_instance.request_invite_with_photo(user_id, data, image)
        print("The response of InviteApi->request_invite_with_photo:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Reset Invite Message
        api_response = await api_instance.reset_invite_message(user_id, message_type, slot)
        print("The response of InviteApi->reset_invite_message:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Respond Invite
        api_response = await api_instance.respond_invite(notification_id, invite_response)
        print("The response of InviteApi->respond_invite:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Respond Invite with photo
        api_response = await api_instance.respond_invite_with_photo(notification_id, data, image)
        print("The response of InviteApi->respond_invite_with_photo:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Update Invite Message
        api_response = await api_instance.update_invite_message(user_id, message_type, slot, update_invite_message_request=update_invite_message_request)
        print("The response of InviteApi->update_invite_message:\n")
        pprint(api_response)
    except Exception as e:
