...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Clear All Player Moderations
        api_response = await api_instance.clear_all_player_moderations()
        print("The response of PlayermoderationApi->clear_all_player_moderations:\n")
        pprint(api_response)
...
async with vrchatapi.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = vrchatapi.PlayermoderationApi(api_client)
    type = 'unmute' # PlayerModerationType | Must be one of PlayerModerationType. (optional) (default to 'unmute')
    target_user_id = 'target_user_id_example' # str | Must be valid UserID. (optional)

    try:
        # Search Player Moderations
        api_response = await api_instance.get_player_moderations(type=type, target_user_id=target_user_id)
        print("The response of PlayermoderationApi->get_player_moderations:\n")
        pprint(api_response)
    except Exception as e:
...
------------- | ------------- | ------------- | -------------
 **type** | [**PlayerModerationType**](.md)| Must be one of PlayerModerationType. | [optional] [default to &#39;unmute&#39;]
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Moderate User
        api_response = await api_instance.moderate_user(moderate_user_request)
        print("The response of PlayermoderationApi->moderate_user:\n")
        pprint(api_response)
    except Exception as e:
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Unmoderate User
        api_response = await api_instance.unmoderate_user(moderate_user_request)
        print("The response of PlayermoderationApi->unmoderate_user:\n")
        pprint(api_response)
    except Exception as e:
