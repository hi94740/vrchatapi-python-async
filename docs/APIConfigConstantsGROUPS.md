...
api_config_constants_groups_instance = APIConfigConstantsGROUPS.from_json(json)
# print the JSON string representation of the object
print(APIConfigConstantsGROUPS.to_json())

# convert the object into a dict
api_config_constants_groups_dict = api_config_constants_groups_instance.to_dict()
# create an instance of APIConfigConstantsGROUPS from a dict
api_config_constants_groups_from_dict = APIConfigConstantsGROUPS.from_dict(api_config_constants_groups_dict)
```
