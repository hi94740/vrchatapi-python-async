...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Group by ID
        api_response = await api_instance.get_group(group_id, include_roles=include_roles)
...
async with vrchatapi.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Group Gallery Images
        api_response = await api_instance.get_group_gallery_images(group_id, group_gallery_id, n=n, offset=offset, approved=approved)
