...
moderation_report_instance = ModerationReport.from_json(json)
# print the JSON string representation of the object
print(ModerationReport.to_json())

# convert the object into a dict
moderation_report_dict = moderation_report_instance.to_dict()
# create an instance of ModerationReport from a dict
moderation_report_from_dict = ModerationReport.from_dict(moderation_report_dict)
```
