...
create_prop_request_instance = CreatePropRequest.from_json(json)
# print the JSON string representation of the object
print(CreatePropRequest.to_json())

# convert the object into a dict
create_prop_request_dict = create_prop_request_instance.to_dict()
# create an instance of CreatePropRequest from a dict
create_prop_request_from_dict = CreatePropRequest.from_dict(create_prop_request_dict)
```
